...
> - **Kartu A — Mata Pelajaran & Guru**: tabel dengan kolom: centang/nama mapel, guru pengajar, jumlah sesi, **Biaya Siswa (Rp)**, **Honor Guru (Rp)**, Margin (kalkulasi otomatis), dan hapus. Setiap baris menampilkan margin (Rp + %) secara real-time saat biaya atau honor diubah. Berisi kontrol "Tambah Mata Pelajaran Lain". Default honor guru diisi otomatis 60% dari biaya siswa — dapat diedit admin. Di bawah daftar mapel terdapat 4 stat-box: **Total Sesi**, **Total Biaya Siswa**, **Total Honor Guru**, dan **Est. Margin Bimbel** (Rp + %) — semua diperbarui real-time.
