...
> Perubahan produk (13 Jul 2026): **Langkah 3 dipecah menjadi dua komponen/kartu terpisah** dalam satu step yang sama. **Kartu A — Mata Pelajaran & Guru**: menampilkan daftar mapel (kolom: centang/nama, guru pengajar, jumlah sesi, biaya, hapus) beserta kontrol "Tambah Mata Pelajaran Lain" dan ringkasan Total Sesi & Total Estimasi Biaya Guru. **Kartu B — Jadwal Kelas**: menampilkan baris jadwal per mapel (kolom: nama mapel, hari, jam mulai, jam selesai, status konflik), bersifat opsional dan tidak memblokir submit. Kedua kartu tetap sinkron — saat mapel dihapus dari Kartu A, baris jadwalnya di Kartu B ikut terhapus; saat mapel dinonaktifkan (uncheck), baris jadwalnya otomatis tersembunyi. Pengecekan konflik jadwal guru tetap berjalan lintas kartu (membaca guru dari Kartu A dan hari/jam dari Kartu B berdasarkan `data-course-id`).
>
