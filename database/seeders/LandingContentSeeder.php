...
class LandingContentSeeder extends Seeder
{
    ...
    private function seedSettings(): void
    {
        $s = [
            ...
            ['galeri','galeri.title_line1','Galeri','Judul Baris 1'],
            ['galeri','galeri.title_accent','Kegiatan','Judul Aksen'],
            ['bantuan','bantuan.eyebrow','Bantuan & Kontak','Eyebrow'],
            ['bantuan','bantuan.title_line1','Pertanyaan &','Judul Baris 1'],
            ['bantuan','bantuan.title_accent','Hubungi Kami','Judul Aksen'],
            ['bantuan','bantuan.subtitle','Punya pertanyaan atau ingin bergabung? Kami siap membantu Anda kapan saja.','Subjudul'],
            ['tutor','tutor.eyebrow','Tim Pengajar','Eyebrow'],
            ['tutor','tutor.title_line1','Tutor','Judul Baris 1'],
            ['tutor','tutor.title_accent','Terbaik','Judul Aksen'],
            ['tutor','tutor.title_line2','Kami','Judul Baris 2'],
            ['tutor','tutor.subtitle','Dilatih secara profesional dan berpengalaman di bidangnya masing-masing untuk memberikan hasil terbaik bagi setiap siswa.','Subjudul'],
