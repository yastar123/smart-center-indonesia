...
class AcademicModuleController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('owner.academic-module.index', compact('modules', 'courses', 'stats'));
    }

    public function create()
    {
        $courses = Course::where('status', 'aktif')->orderBy('nama')->get();
        return view('owner.academic-module.create', compact('courses'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if (!$request->hasFile('module_file') && !$request->filled('video_url')) {
            return redirect()->back()
                ->withErrors(['module_file' => 'Upload file modul (PDF/DOC/DOCX) atau isi link video wajib diisi.'])
                ->withInput();
        }
        ...
        return redirect()->route('owner.module.index')
    ...
    public function show(Module $module)
    {
        ...
        return view('owner.academic-module.detail', compact('module'));
    }

    public function edit(Module $module)
    {
        $courses = Course::where('status', 'aktif')->orderBy('nama')->get();
        return view('owner.academic-module.edit', compact('module', 'courses'));
    }
