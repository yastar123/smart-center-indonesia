...
class SubjectController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('owner.subject.index', compact('subjects', 'branches', 'stats'));
    }

    public function create()
    {
        $branches = Branch::orderBy('name')->get();
        return view('owner.subject.create', compact('branches'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('owner.subject.index')
    ...
    public function show(Course $subject)
    {
        ...
        return view('owner.subject.detail', compact('subject'));
    }

    public function edit(Course $subject)
    {
        $branches = Branch::orderBy('name')->get();
        return view('owner.subject.edit', compact('subject', 'branches'));
    }
