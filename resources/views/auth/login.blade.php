...
<div class="login-wrapper">
    ...
    <div class="login-left">
        ...
        <a href="{{ route('register') }}" style="display:inline-flex;align-items:center;gap:6px;color:rgba(255,255,255,.6);font-size:.78rem;font-weight:600;text-decoration:none;margin-bottom:1.25rem;transition:color .2s;" onmouseover="this.style.color='rgba(255,255,255,.95)'" onmouseout="this.style.color='rgba(255,255,255,.6)'">
        ...
        <div class="feature-grid">
            ...
            <div class="feature-item">
                ...
                <div class="feature-num">{{ $fmtStat($loginStats['classes']) }}{{ $loginStats['classes'] > 0 ? '+' : '' }}</div>
