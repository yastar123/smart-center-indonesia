...
{{-- HEADER --}}
<div class="dashboard-card mb-4" style="background:linear-gradient(135deg,#92400e 0%,#f59e0b 100%);color:white;border:none;overflow:hidden;position:relative">
...
<div class="row g-3 mb-4">
    <div class="col-6 col-md-3"><div class="stat-card"><div class="d-flex justify-content-between"><div><div class="stat-title">Total</div><div class="stat-value" data-target="{{ $certificates->count() }}" class="count-up">{{ $certificates->count() }}</div></div><div class="stat-icon" style="background:#f59e0b22;color:#f59e0b"><i class="bi bi-award"></i></div></div></div></div>
    <div class="col-6 col-md-3"><div class="stat-card"><div class="d-flex justify-content-between"><div><div class="stat-title">Kompetensi</div><div class="stat-value">{{ $certificates->where('jenis','kompetensi')->count() }}</div></div><div class="stat-icon" style="background:#c84ddf22;color:#c84ddf"><i class="bi bi-patch-check"></i></div></div></div></div>
    <div class="col-6 col-md-3"><div class="stat-card"><div class="d-flex justify-content-between"><div><div class="stat-title">Kelulusan</div><div class="stat-value">{{ $certificates->where('jenis','kelulusan')->count() }}</div></div><div class="stat-icon" style="background:#10b98122;color:#10b981"><i class="bi bi-mortarboard"></i></div></div></div></div>
    <div class="col-6 col-md-3"><div class="stat-card"><div class="d-flex justify-content-between"><div><div class="stat-title">Prestasi</div><div class="stat-value">{{ $certificates->whereIn('jenis',['prestasi','partisipasi'])->count() }}</div></div><div class="stat-icon" style="background:#ef444422;color:#ef4444"><i class="bi bi-trophy"></i></div></div></div></div>
</div>
