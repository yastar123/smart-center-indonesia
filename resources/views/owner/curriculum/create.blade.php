@extends('layouts.app')
@section('title', 'Tambah Kurikulum & Silabus')
@section('page-title', 'Tambah Kurikulum & Silabus')
...
<form action="{{ route('owner.curriculum.store') }}" method="POST" enctype="multipart/form-data">
@csrf
...
<div class="row g-4">
    ...
    <div class="col-lg-4">
        <div class="dashboard-card fade-up">
            ...
            <div class="mb-3">
                ...
                <div class="d-flex gap-3">
                    ...
                    <label class="d-flex align-items-center gap-2 p-3 flex-1"
                           style="border:1.5px solid var(--card-border);border-radius:12px;cursor:pointer;flex:1;transition:.15s"
                           id="lbl-lokal">
                        <input type="radio" name="scope" value="lokal" {{ old('scope') === 'lokal' ? 'checked' : '' }}
                               onchange="toggleBranch(this.value)" class="d-none">
            ...
            <div class="mb-3" id="branch-row" style="{{ old('scope') === 'lokal' ? '' : 'display:none' }}">
