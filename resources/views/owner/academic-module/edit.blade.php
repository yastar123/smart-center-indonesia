...
<div class="row g-4">
    <div class="col-lg-8">
        <form method="POST" action="{{ route('owner.module.update', $module) }}" enctype="multipart/form-data">
        @csrf @method('PUT')
        <div class="dashboard-card">
            ...
            <div class="d-flex gap-2 mt-4">
                ...
                <a href="{{ route('owner.module.show', $module) }}" class="btn btn-outline-secondary fw-semibold px-4">
