...
<div class="row g-4">
    <div class="col-lg-8">
        <form method="POST" action="{{ route('owner.module.store') }}" enctype="multipart/form-data">
        @csrf
        <div class="dashboard-card">
            ...
            <div class="d-flex gap-2 mt-4">
                ...
                <a href="{{ route('owner.module.index') }}" class="btn btn-outline-secondary fw-semibold px-4">
