...
@section('page-title', 'Registrasi Siswa Baru')
                ...
                <div class="row g-2 align-items-center">
                    <div class="col-md-3">
                        <div class="form-check">
                            <input class="form-check-input course-check" type="checkbox" name="course_ids[]" value="{{ $course->id }}" id="course{{ $course->id }}">
                            <label class="form-check-label fw-semibold" for="course{{ $course->id }}">{{ $course->nama }}</label>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <select class="form-select form-select-sm" name="course_teacher[{{ $course->id }}]" disabled>
                    ...
                    <div class="col-md-2">
                        <input type="number" min="1" class="form-control form-control-sm" name="course_sessions[{{ $course->id }}]" placeholder="Jml sesi" value="8" disabled>
                    </div>
                    <div class="col-md-4">
                        <div class="input-group input-group-sm">
                            <span class="input-group-text">Rp</span>
                            <input type="number" min="0" class="form-control fee-input" name="course_fee[{{ $course->id }}]" value="{{ $fee }}" disabled>
                        </div>
                    </div>
                </div>
            </div>
...
@push('scripts')
<script>
const _wizardUrl = "{{ route('admin.registration.wizard.store') }}";
