...
<div class="dashboard-card mb-4" style="background:linear-gradient(135deg,#260632 0%,#461256 50%,#c84ddf 100%);color:white;border:none;overflow:hidden;position:relative">
    ...
    <div class="d-flex align-items-center justify-content-between flex-wrap gap-3" style="position:relative">
        ...
        <a href="{{ route('admin.registration-list.create') }}"
    ...
    <form method="GET" action="{{ route('admin.registration-list.index') }}" class="row g-2 align-items-end">
        ...
        <div class="col-6 col-md-2">
            ...
            <select name="academic_status" class="form-select form-select-sm">
                ...
                <option value="menunggu_kelas" {{ request('academic_status')==='menunggu_kelas' ?'selected':'' }}>Atur Jadwal</option>
            ...
            <tr>
                ...
                <td style="padding:12px">
                    <span class="badge d-inline-flex align-items-center gap-1"
                        ...
                        <i class="bi {{ $acadBadge[3] }}" style="font-size:.72rem"></i>
                        {{ $acadBadge[2] }}
                    </span>
                </td>
