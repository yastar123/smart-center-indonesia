            ...
            <div class="row g-4 align-items-start">
                ...
                <div class="col-lg-9">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6" id="gajiSectionEdit" style="{{ old('jenis_guru', $teacher->jenis_guru) == 'kontrak' ? '' : 'display:none' }}">
                            ...
                            <div class="input-group input-group-sm">
                                ...
                                <input type="number" name="salary_base" id="salary_base_edit" class="form-control"
                                       ...
                                       value="{{ old('salary_base', $teacher->jenis_guru == 'kontrak' && $teacher->salary_base > 0 ? (int)$teacher->salary_base : '') }}"
                                       {{ old('jenis_guru', $teacher->jenis_guru) == 'kontrak' ? 'required' : '' }}>
                            </div>
