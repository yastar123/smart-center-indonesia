    ...
    <main class="register-shell">
        ...
        <section class="register-panel">
            <div class="register-card">
                ...
                <form id="teacherRegistrationForm" method="POST" action="{{ route('public.teacher-registrations.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row g-3">
                        <div class="col-md-6">
                    ...
                    <div class="d-flex gap-2 mt-4">
                        ...
                        <a href="{{ url('/') }}" class="btn btn-outline-secondary px-4">Kembali</a>
                    </div>
