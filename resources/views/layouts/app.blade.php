...
<nav class="sidebar" id="sidebar">
    ...
    <div class="sidebar-nav">
        ...
        <div class="nav-item">
            <a href="{{ route('admin.registration-list.index') }}" class="nav-link {{ request()->routeIs('admin.registration-list.*') ? 'active' : '' }}" data-label="Registrasi">
        ...
        <div class="nav-item">
            <a href="{{ route('admin.rooms.index') }}" class="nav-link {{ request()->routeIs('admin.rooms.*') ? 'active' : '' }}" data-label="Fasilitas Ruangan">
                <i class="bi bi-door-open-fill"></i>
                <span>Fasilitas Ruangan</span>
            </a>
        </div>
        <div class="nav-item">
            <a href="{{ route('admin.leave.index') }}" class="nav-link {{ request()->routeIs('admin.leave.*') ? 'active' : '' }}" data-label="Cuti & Freeze">
                <i class="bi bi-snow2"></i>
                <span>Cuti & Freeze</span>
                @php $pendingLeave = \App\Models\StudentLeave::where('status','pending')->count(); @endphp
                @if($pendingLeave > 0)
                    <span class="menu-badge">{{ $pendingLeave > 99 ? '99+' : $pendingLeave }}</span>
                @endif
            </a>
        </div>
        ...
        <div class="nav-item">
            <a href="{{ route('admin.articles.index') }}" class="nav-link {{ request()->routeIs('admin.articles.*') ? 'active' : '' }}" data-label="Artikel">
        ...
        <div class="nav-item">
            <a href="{{ route('guru.classes.index') }}" class="nav-link {{ request()->routeIs('guru.classes.*') ? 'active' : '' }}" data-label="Kelas Absensi">
        ...
        <div class="nav-item">
            <a href="{{ route('siswa.leave.index') }}" class="nav-link {{ request()->routeIs('siswa.leave.*') ? 'active' : '' }}" data-label="Cuti & Freeze">
...
(function() {
    const cmdPages = [
        ...
        { label:'Registrasi Siswa Baru', desc:'Daftarkan siswa & buat paket', href:'{{ route("admin.registration-list.create") }}', icon:'bi-person-plus', color:'#c84ddf', group:'Akademik' },
