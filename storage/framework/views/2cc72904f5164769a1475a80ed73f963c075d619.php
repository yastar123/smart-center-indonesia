...
<nav aria-label="breadcrumb" class="mb-3">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="<?php echo e(route('admin.billing.index')); ?>">Billing</a></li>
        <li class="breadcrumb-item active"><?php echo e($billing->nomor_invoice); ?></li>
    </ol>
</nav>
...
<div class="row g-4">
        ...
        <div class="dashboard-card">
            ...
            <div class="d-flex align-items-start justify-content-between mb-4 pb-3 border-bottom">
                <div>
                    ...
                    <h5 class="fw-bold mb-1" style="color:#461256"><?php echo e($billing->nomor_invoice); ?></h5>
                    <div class="text-muted" style="font-size:13px">Diterbitkan: <?php echo e($billing->created_at->format('d F Y')); ?></div>
                </div>
                <span style="background:<?php echo e($s['bg']); ?>;color:<?php echo e($s['fg']); ?>;padding:8px 16px;border-radius:20px;font-size:14px;font-weight:600">
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <div class="fw-semibold"><?php echo e($billing->siswa?->name ?? '—'); ?></div>
                </div>
                <div class="col-md-6">
                    ...
                    <div class="fw-semibold"><?php echo e($billing->cabang?->name ?? '—'); ?></div>
                </div>
                <div class="col-md-6">
                    ...
                    <div class="fw-semibold"><?php echo e($billing->jatuh_tempo ? $billing->jatuh_tempo->format('d F Y') : '—'); ?></div>
                </div>
                <div class="col-md-6">
                    ...
                    <div class="fw-semibold"><?php echo e($billing->periode ?? '—'); ?></div>
                </div>
                <div class="col-12">
                    ...
                    <div class="fw-semibold"><?php echo e($billing->deskripsi ?? '—'); ?></div>
                </div>
                <?php if($billing->catatan): ?>
                <div class="col-12">
                    ...
                    <div class="p-3 rounded" style="background:var(--input-bg)"><?php echo e($billing->catatan); ?></div>
                </div>
                <?php endif; ?>
            </div>
            ...
            <div class="mt-4 pt-3 border-top">
                <div class="d-flex justify-content-between py-2">
                    ...
                    <span class="fw-semibold">Rp <?php echo e(number_format($billing->subtotal,0,',','.')); ?></span>
                </div>
                <?php if($billing->diskon > 0): ?>
                <div class="d-flex justify-content-between py-2">
                    <span class="text-muted">Diskon</span>
                    <span class="fw-semibold text-success">- Rp <?php echo e(number_format($billing->diskon,0,',','.')); ?></span>
                </div>
                <?php endif; ?>
                <?php if($billing->pajak > 0): ?>
                <div class="d-flex justify-content-between py-2">
                    <span class="text-muted">Pajak</span>
                    <span class="fw-semibold">Rp <?php echo e(number_format($billing->pajak,0,',','.')); ?></span>
                </div>
                <?php endif; ?>
                <div class="d-flex justify-content-between py-2 border-top mt-1">
                    <span class="fw-bold" style="font-size:16px">Total Tagihan</span>
                    <span class="fw-bold" style="font-size:18px;color:#461256">Rp <?php echo e(number_format($billing->total,0,',','.')); ?></span>
                </div>
            </div>

            <div class="d-flex gap-2 mt-4">
                <a href="<?php echo e(route('admin.billing.index')); ?>" class="btn btn-outline-secondary fw-semibold">
    ...
    <div class="col-lg-4">
        <div class="dashboard-card">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $billing->pembayaran; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pay): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="d-flex justify-content-between align-items-start py-2 border-bottom">
                    <div>
                        <div class="fw-semibold" style="font-size:13px">Rp <?php echo e(number_format($pay->jumlah,0,',','.')); ?></div>
                        <div class="text-muted" style="font-size:12px"><?php echo e(\Carbon\Carbon::parse($pay->tanggal_pembayaran)->format('d M Y')); ?></div>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/runner/workspace/resources/views/admin/billing/detail.blade.php ENDPATH**/ ?>