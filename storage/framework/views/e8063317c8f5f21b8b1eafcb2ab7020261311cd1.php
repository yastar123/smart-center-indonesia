    ...
    <div class="col-lg-7">
        ...
        <div class="dashboard-card text-center py-5 px-4 fade-up" style="border-top:4px solid #c84ddf">
            ...
            <div class="d-flex gap-2 justify-content-center flex-wrap">
                <a href="<?php echo e(route('guru.dashboard')); ?>" class="btn btn-primary fw-semibold px-4" style="border-radius:10px">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/runner/workspace/resources/views/guru/coming-soon.blade.php ENDPATH**/ ?>