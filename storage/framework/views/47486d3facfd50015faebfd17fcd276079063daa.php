...
<div class="dashboard-card fade-up">
                ...
                <tr style="border-bottom:1px solid var(--card-border);vertical-align:middle">
                    ...
                    <td class="ps-3">
                        <div class="d-flex align-items-start gap-3">
                            ...
                            <div style="min-width:0">
                                <div class="fw-bold text-truncate" style="font-size:13px;max-width:180px"><?php echo e($row['nama_kelas']); ?></div>
                                <span class="badge mt-1" style="background:var(--soft-primary-bg);color:var(--soft-primary-text);font-size:10px;border-radius:6px">
                                    <?php echo e($row['subject_name']); ?>
                    ...
                    <td>
                        ...
                        ?>
                        <span class="badge fw-bold" style="<?php echo e($tipeBg); ?>;font-size:10px;border-radius:6px;letter-spacing:.04em">
                            <?php echo e($row['tipe_label']); ?>
                    ...
                    <td>
                        ...
                        <?php elseif($ni['type'] === 'berlangsung'): ?>
                        ...
                        <?php elseif($ni['type'] === 'proposed'): ?>
                            <div>
                                ...
                                <?php $__currentLoopData = $ni['slots']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="text-muted" style="font-size:11px"><i class="bi bi-clock me-1"></i><?php echo e($slot); ?></div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                        <?php elseif($ni['type'] === 'jadwal'): ?>
                            <div class="fw-semibold" style="font-size:13px;color:var(--text-color)">
                                <i class="bi bi-calendar3 me-1 text-muted" style="font-size:11px"></i><?php echo e($ni['text']); ?>
                    ...
                    <td>
                        ...
                        <div class="mt-2" style="height:6px;background:var(--card-border);border-radius:99px;width:110px;overflow:hidden">
                            <div style="height:100%;width:<?php echo e($pct); ?>%;background:<?php echo e($barClr); ?>;border-radius:99px;transition:width .4s"></div>
                        </div>
                        <div class="text-muted mt-1" style="font-size:10px"><?php echo e($pct); ?>% selesai</div>
                        <?php endif; ?>
                    </td>

                    
                    <td>
                        <span style="background:<?php echo e($badge['bg']); ?>;color:<?php echo e($badge['color']); ?>;padding:5px 11px;border-radius:8px;font-size:11px;font-weight:600;white-space:nowrap">
                    ...
                    <td class="text-center">
                        <div class="d-flex gap-1 flex-wrap justify-content-center">
                            <?php if($row['status'] === 'proposed'): ?>
                                <?php $__currentLoopData = $row['proposals']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proposal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <form method="POST" action="<?php echo e(route('siswa.schedule-agreements.reject', $proposal->id)); ?>" class="d-inline">
                                    <?php echo csrf_field(); ?>
                                    <button type="submit" class="btn btn-sm btn-outline-danger fw-semibold" style="font-size:11px;border-radius:8px">
                                        <i class="bi bi-x-lg me-1"></i>Tolak
                                    </button>
                                </form>
                                <form method="POST" action="<?php echo e(route('siswa.schedule-agreements.approve', $proposal->id)); ?>" class="d-inline">
                                    <?php echo csrf_field(); ?>
                            ...
                            <?php else: ?>
                                ...
                                <a href="<?php echo e(route('siswa.certificates.index')); ?>" class="btn btn-sm fw-semibold"
                                ...
                                <?php endif; ?>
                                <a href="<?php echo e(route('siswa.attendance.show', $row['id'])); ?>" class="btn btn-sm btn-primary fw-semibold" style="font-size:11px;border-radius:8px">
    ...
    <div class="mt-4 d-flex justify-content-between align-items-center flex-wrap gap-2">
        <div class="text-muted" style="font-size:13px">
            Menampilkan <?php echo e($paginator->firstItem()); ?> - <?php echo e($paginator->lastItem()); ?> dari <?php echo e($paginator->total()); ?> Paket
        </div>
        <div><?php echo e($paginator->links()); ?></div>
    </div>
    <?php else: ?>
    <div class="mt-3 text-muted" style="font-size:13px">
        Menampilkan 1 - <?php echo e($paginator->count()); ?> dari <?php echo e($paginator->total()); ?> Paket
    </div>
    <?php endif; ?>
</div>
