                ...
                <div class="row g-3">
                        ...
                        <select name="package_id" id="package_id" class="form-select form-select-sm" onchange="onPackageChange(this.value)">
                            ...
                            <?php $__currentLoopData = $packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pkg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($pkg->id); ?>"
                                    data-sesi="<?php echo e($pkg->jumlah_pertemuan ?? 0); ?>"
                                    <?php echo e(old('package_id') == $pkg->id ? 'selected' : ''); ?>>
                                    <?php echo e($pkg->nama); ?>

                                    <?php if($pkg->jumlah_pertemuan): ?> (<?php echo e($pkg->jumlah_pertemuan); ?> sesi)<?php endif; ?>
                                </option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div class="col-md-4">
                        ...
                        <input type="number" name="total_sesi" id="total_sesi" class="form-control form-control-sm"
                               min="0" max="9999" value="<?php echo e(old('total_sesi', 0)); ?>"
                               placeholder="0">
