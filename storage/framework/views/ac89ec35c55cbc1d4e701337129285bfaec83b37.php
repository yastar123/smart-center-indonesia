...
<section class="bl-section bl-faq-section" id="faq">
    <div class="container-bl">
        <div class="text-center reveal">
            ...
            <h2 class="bl-section-title">Pertanyaan Umum<br><em>Les Privat <?php echo e($cityName); ?></em></h2>
            <p class="bl-section-sub mx-auto" style="text-align:center">
                Temukan jawaban atas pertanyaan yang sering diajukan tentang layanan SCI <?php echo e($cityName); ?>.
            </p>
        </div>
    ...
    <div class="container-bl">
        <div class="bl-cta-box reveal">
            <div class="bl-cta-inner">
                ...
                <h2 class="bl-cta-title">Siap Mulai Belajar<br><em><?php echo e($cityName); ?>?</em></h2>
                <p class="bl-cta-desc">
                    Bergabung dengan <?php echo e(number_format($studentCount)); ?>+ siswa SCI <?php echo e($cityName); ?> yang telah merasakan manfaatnya.
