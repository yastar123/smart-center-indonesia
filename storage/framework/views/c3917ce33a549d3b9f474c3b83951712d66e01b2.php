                                        ...
                                        <div class="col-6 col-md-4">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="custom_course_ids[]"
                                                       value="<?php echo e($c->id); ?>" id="cus_course_<?php echo e($c->id); ?>"
                                                       <?php echo e(in_array($c->id, old('custom_course_ids', [])) ? 'checked' : ''); ?>>
                                                <label class="form-check-label" for="cus_course_<?php echo e($c->id); ?>" style="font-size:13px">
                                                    <?php echo e($c->nama); ?>
...
unset($__errorArgs, $__bag); ?>" required onchange="updateTeacherType(this); updateSelectedTeacherDetails()">
                        ...
                        <?php $__currentLoopData = $teachers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <option value="<?php echo e($t->id); ?>"
                                ...
                                <?php echo e($t->name); ?> - <?php echo e($teacherSubjects ?: '-'); ?> - <?php echo e($teacherBranch); ?> - <?php echo e($t->jenis_guru ?? '-'); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Edu Juanda Pratama\Downloads\smart-center-indonesia-2\smart-center-indonesia-2\resources\views/admin/registration/create.blade.php ENDPATH**/ ?>