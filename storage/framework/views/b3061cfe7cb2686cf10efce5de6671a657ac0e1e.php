...
<div class="row g-3 mb-4">
    ...
    <div class="col-6 col-md-3 fade-up" style="animation-delay:.10s">
        ...
        ?>
        <div class="stat-card" style="border-top:3px solid <?php echo e($sesiBrd); ?>">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    <div class="stat-title">Sisa Sesi</div>
                    <div class="stat-value" style="color:<?php echo e($sesiClr); ?>"><?php echo e($sisaSesi); ?></div>
                    <div class="stat-label text-muted" style="font-size:11px">
                        <i class="bi bi-layers me-1"></i><?php echo e($sesiLabel); ?> dari <?php echo e($totalSesi); ?>

                    </div>
                </div>
                <div class="stat-icon <?php echo e($sesiIcon); ?>" style="color:white">
        ...
        <div class="stat-card" style="border-top:3px solid #0284c7">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    ...
                    <div class="stat-value" style="color:#0284c7"><?php echo e($sesiPakai); ?></div>
                    <div class="stat-label text-muted" style="font-size:11px">
                        <i class="bi bi-check2-circle me-1"></i>dari <?php echo e($totalSesi); ?> total sesi
                    </div>
                </div>
...
<div class="dashboard-card fade-up">
    ...
    <?php else: ?>
    <div class="row g-3">
        <?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php
        ...
        <div class="col-md-6 col-lg-4">
            <a href="<?php echo e(route('siswa.attendance.show', $c->id)); ?>"
               ...
               onmouseover="this.style.borderColor='<?php echo e($clr); ?>';this.style.transform='translateY(-2px)'"
               onmouseout="this.style.borderColor='var(--card-border)';this.style.transform='translateY(0)'">
                <div class="d-flex align-items-start gap-3">
                    <div style="width:48px;height:48px;border-radius:14px;background:<?php echo e($clr); ?>18;display:flex;align-items:center;justify-content:center;flex-shrink:0">
                ...
                <div class="d-flex align-items-center justify-content-between mt-3 pt-3"
                    ...
                    <span style="font-size:11.5px;color:<?php echo e($clr); ?>;font-weight:600">
                        <i class="bi bi-calendar-event me-1"></i><?php echo e($meetings); ?> Pertemuan
                        <?php if($summary): ?>
                        · Hadir <?php echo e($summary->hadir); ?>/<?php echo e($summary->total); ?>

                        <?php endif; ?>
                    </span>
                    <i class="bi bi-arrow-right" style="color:<?php echo e($clr); ?>;font-size:13px"></i>
                </div>
            </a>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/runner/workspace/resources/views/siswa/attendance/index.blade.php ENDPATH**/ ?>