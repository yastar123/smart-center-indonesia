...
<?php $__env->startSection('page-title','Dashboard Pengumuman'); ?>
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <div class="p-2 rounded-3" style="background:var(--input-bg);border:1.5px solid var(--card-border);max-height:180px;overflow:auto">
                                        ...
                                        <div class="form-check mb-1">
                                            <input class="form-check-input target-teacher" type="checkbox" name="target_teacher_ids[]" value="<?php echo e($teacher->id); ?>" id="annTeacher<?php echo e($teacher->id); ?>">
                                            <label class="form-check-label small" for="annTeacher<?php echo e($teacher->id); ?>"><?php echo e($teacher->name); ?></label>
                                        </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="p-2 rounded-3" style="background:var(--input-bg);border:1.5px solid var(--card-border);max-height:180px;overflow:auto">
                                        ...
                                        <div class="form-check mb-1">
                                            <input class="form-check-input target-student" type="checkbox" name="target_student_ids[]" value="<?php echo e($student->id); ?>" id="annStudent<?php echo e($student->id); ?>">
                                            <label class="form-check-label small" for="annStudent<?php echo e($student->id); ?>"><?php echo e($student->name); ?></label>
                                        </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                </div>
...
function loadData(page=1) {
    ...
    fetch(`<?php echo e(route('admin.announcements.index')); ?>?${params}`, { headers:{'X-Requested-With':'XMLHttpRequest'} })
...
function editAnn(id) {
    fetch(`<?php echo e(url('admin/announcements')); ?>/${id}`, { headers:{'X-Requested-With':'XMLHttpRequest'} })
        .then(r=>{ if(!r.ok) throw new Error('HTTP '+r.status); return r.json(); })
        .then(res => {
...
function deleteAnn(id, title) {
    confirmAction(`Hapus pengumuman "${title}"? Data tidak dapat dikembalikan.`, function() {
        fetch(`<?php echo e(url('admin/announcements')); ?>/${id}`, {method:'DELETE',headers:{'X-CSRF-TOKEN':'<?php echo e(csrf_token()); ?>','X-Requested-With':'XMLHttpRequest'}})
            .then(r=>{ if(!r.ok) throw new Error('HTTP '+r.status); return r.json(); })
...
document.getElementById('annForm').addEventListener('submit', function(e) {
    ...
    const url = id ? `<?php echo e(url('admin/announcements')); ?>/${id}` : `<?php echo e(route('admin.announcements.store')); ?>`;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/runner/workspace/resources/views/admin/announcements/index.blade.php ENDPATH**/ ?>