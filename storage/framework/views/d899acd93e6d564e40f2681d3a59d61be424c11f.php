...
<?php $__env->startSection('page-title', 'Analytics & Insight'); ?>
        ...
        <div class="stat-card" style="border-top:3px solid #c84ddf">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    ...
                    <div class="stat-value text-primary"><?php echo e($totalStudents); ?></div>
                    <div class="stat-label" style="font-size:11px;color:#10b981">
                        <i class="bi bi-arrow-up-short"></i>+<?php echo e($newThisMonth); ?> bulan ini
                    </div>
                </div>
        ...
        <div class="stat-card" style="border-top:3px solid #10b981">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    ...
                    <div class="stat-value" style="color:#059669"><?php echo e($totalTeachers); ?></div>
        ...
        <div class="stat-card" style="border-top:3px solid #68117e">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    ...
                    <div class="stat-value" style="color:#c84ddf"><?php echo e($activeBranches); ?></div>
                    <div class="stat-label" style="font-size:11px;color:var(--text-muted)">
        ...
        <div class="dashboard-card h-100">
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <span class="badge" style="background:var(--soft-primary-bg);color:var(--soft-primary-text);padding:4px 10px;font-size:11px;border-radius:7px">
                    +<?php echo e(array_sum($studentData)); ?> total
                </span>
            </div>
        ...
        <div class="dashboard-card h-100">
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <span class="badge" style="background:var(--soft-success-bg);color:var(--soft-success-text);padding:4px 10px;font-size:11px;border-radius:7px">
                    Rp <?php echo e(number_format(array_sum($revData), 0, ',', '.')); ?>
...
<div class="dashboard-card fade-up">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="<?php echo e(route('owner.branches.index')); ?>" class="btn btn-sm btn-outline-primary" style="border-radius:8px;font-size:11px;padding:4px 12px">
    ...
    <?php else: ?>
    <div class="row g-3">
        <?php $__currentLoopData = $branches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php
            ...
            <div class="p-3 rounded-3" style="background:var(--input-bg);border:1px solid var(--card-border)">
                <div class="d-flex align-items-center justify-content-between mb-2">
                    <div class="d-flex align-items-center gap-2">
                        <div style="width:30px;height:30px;border-radius:9px;background:<?php echo e($rankBadge['bg']); ?>;display:flex;align-items:center;justify-content:center;color:white;font-size:<?php echo e($i < 3 ? '14px' : '12px'); ?>;font-weight:700;flex-shrink:0;box-shadow:0 3px 8px rgba(0,0,0,.15)">
                            <?php echo e($rankBadge['label']); ?>

                        </div>
                        <div>
                            <div class="fw-semibold" style="font-size:13px"><?php echo e($b->name); ?></div>
                            <div class="text-muted" style="font-size:11px"><?php echo e($b->city ?? 'N/A'); ?></div>
                        </div>
                    </div>
                    <div class="text-end">
                        <div class="fw-bold" style="font-size:14px;color:<?php echo e($i === 0 ? '#e09000' : ($i === 1 ? '#64748b' : ($i === 2 ? '#a0522d' : '#c84ddf'))); ?>"><?php echo e($b->students_count); ?></div>
                ...
                <div style="height:5px;background:var(--card-border);border-radius:10px;overflow:hidden">
                    <div style="width:<?php echo e($pct); ?>%;height:100%;background:<?php echo e($barColor); ?>;border-radius:10px;transition:width .8s ease"></div>
                </div>
                <div class="d-flex justify-content-between mt-1" style="font-size:10.5px;color:var(--text-muted)">
                    <span><?php echo e($b->aktif_count); ?> aktif</span>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    new ApexCharts(document.getElementById('chartStudentGrowth'), {
        ...barOpts,
        series: [{ name:'Siswa Baru', data:<?php echo json_encode($studentData); ?> }],
        xaxis:  { ...barOpts.xaxis, categories:<?php echo json_encode($studentMonths); ?> },
        colors: ['#c84ddf'],
    }).render();

    new ApexCharts(document.getElementById('chartRevTrend'), {
        ...barOpts,
        series: [{ name:'Revenue (Rp)', data:<?php echo json_encode($revData); ?> }],
        xaxis:  { ...barOpts.xaxis, categories:<?php echo json_encode($revMonths); ?> },
        colors: ['#10b981'],
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/runner/workspace/resources/views/owner/analytics.blade.php ENDPATH**/ ?>