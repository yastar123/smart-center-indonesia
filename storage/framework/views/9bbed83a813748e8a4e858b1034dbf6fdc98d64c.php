...
<div class="dashboard-card mb-4 fade-up" style="background:linear-gradient(135deg,#260632 0%,#461256 50%,#c84ddf 100%);color:white;border:none;overflow:hidden;position:relative">
    ...
    <div class="row align-items-center g-3" style="position:relative">
        ...
        <div class="col-md-4 text-md-end">
            <a href="<?php echo e(route('admin.registration-list.create')); ?>" class="btn fw-semibold px-4"
...
<div class="dashboard-card fade-up">
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-3">
        ...
        <div class="d-flex gap-2 flex-wrap">
            ...
            <a href="<?php echo e(route('admin.registration-list.create')); ?>" class="btn btn-primary btn-sm">
                ...
                <tr>
                    <td colspan="6" class="py-5">
                        <div class="text-center">
                            ...
                            <?php endif; ?>
                            <a href="<?php echo e(route('admin.registration-list.create')); ?>" class="btn btn-sm btn-primary">
                                <i class="bi bi-plus-lg me-1"></i>Tambah Siswa
                            </a>
                        </div>
                    </td>
