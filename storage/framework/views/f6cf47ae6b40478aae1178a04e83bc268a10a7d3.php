...
<?php $__env->startSection('page-title', 'Detail Modul'); ?>
        ...
        <div class="dashboard-card">
            ...
            <div class="d-flex align-items-start justify-content-between mb-4 pb-3 border-bottom">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <h5 class="fw-bold mb-1"><?php echo e($module->judul); ?></h5>
                        <?php if($module->kode_modul): ?>
                            <code style="background:var(--soft-primary);color:#461256;padding:3px 10px;border-radius:6px;font-size:13px;font-weight:600">
                                <?php echo e($module->kode_modul); ?>

                            </code>
                        <?php endif; ?>
                    </div>
                </div>
                <?php if($module->status === 'aktif'): ?>
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <div class="fw-semibold"><?php echo e($module->mataPelajaran?->nama ?? '—'); ?></div>
                </div>
                <div class="col-md-3">
                    ...
                    <div class="fw-semibold text-capitalize"><?php echo e($module->jenis ?? '—'); ?></div>
                </div>
                <div class="col-md-3">
                    ...
                    <div class="fw-semibold"><?php echo e($module->created_at->format('d M Y')); ?></div>
                </div>
                ...
                <div class="col-12">
                    ...
                    <div class="p-3 rounded" style="background:var(--input-bg);line-height:1.7"><?php echo e($module->deskripsi); ?></div>
                </div>
                <?php endif; ?>
            </div>
        ...
        <div class="dashboard-card">
            ...
            <div class="d-flex flex-column gap-3">
                <div class="d-flex justify-content-between">
                    ...
                    <span class="fw-semibold" style="font-size:13px"><?php echo e($module->kode_modul ?: '—'); ?></span>
                </div>
                <div class="d-flex justify-content-between">
                    <span class="text-muted" style="font-size:13px">Jenis</span>
                    <span class="fw-semibold text-capitalize" style="font-size:13px"><?php echo e($module->jenis ?? 'Materi'); ?></span>
                </div>
                <div class="d-flex justify-content-between">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <span class="fw-semibold" style="font-size:13px"><?php echo e($module->mataPelajaran?->nama ?? '—'); ?></span>
                </div>
            </div>
        </div>
    </div>
