...
<head>
    ...
    <title>Pendaftaran Berhasil | Smart Center Indonesia</title>
...
<div class="card-wrap">
    <div class="card-header-band">
        ...
        <p>Data pendaftaran <?php echo e($studentName); ?> telah kami terima</p>
    </div>
    ...
    <div class="card-body">
        ...
        <div class="text-center mt-4 pt-3 border-top">
            <a href="<?php echo e(url('/')); ?>" class="btn btn-outline-secondary btn-sm px-4" style="border-radius:10px">
...
<?php /**PATH C:\Users\Edu Juanda Pratama\Downloads\smart-center-indonesia-1\smart-center-indonesia-1\resources\views/auth/register-success.blade.php ENDPATH**/ ?>