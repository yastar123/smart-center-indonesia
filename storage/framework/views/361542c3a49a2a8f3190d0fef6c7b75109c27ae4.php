<?php $__env->startSection('title', $title ?? 'Segera Hadir'); ?>
<?php $__env->startSection('page-title', $title ?? 'Segera Hadir'); ?>
    ...
    <div class="col-lg-7">
        ...
        <div class="dashboard-card text-center py-5 px-4 fade-up" style="border-top:4px solid #c84ddf">
            <div style="width:90px;height:90px;border-radius:28px;background:linear-gradient(135deg,#68117e,#c84ddf);display:flex;align-items:center;justify-content:center;margin:0 auto 24px;box-shadow:0 16px 40px rgba(200,77,223,.3)">
                <i class="bi <?php echo e($icon ?? 'bi-tools'); ?> text-white" style="font-size:40px"></i>
            </div>
            ...
            <h4 class="fw-bold mb-3" style="letter-spacing:-.02em"><?php echo e($title ?? 'Fitur Segera Hadir'); ?></h4>
            <p class="text-muted mb-4" style="max-width:400px;margin:0 auto;font-size:14px;line-height:1.6">
                <?php echo e($desc ?? 'Fitur ini sedang dalam pengembangan aktif dan akan segera tersedia.'); ?>
            ...
            <div class="d-flex gap-2 justify-content-center flex-wrap">
                <a href="<?php echo e(route('siswa.dashboard')); ?>" class="btn btn-primary fw-semibold px-4" style="border-radius:10px">
                    <i class="bi bi-arrow-left me-2"></i>Kembali ke Dashboard
                </a>
                <a href="<?php echo e(route('profile.edit')); ?>" class="btn btn-outline-secondary fw-semibold px-4" style="border-radius:10px">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/runner/workspace/resources/views/siswa/coming-soon.blade.php ENDPATH**/ ?>