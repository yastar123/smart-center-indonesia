                    ...
                    <div class="table-responsive">
                        <table class="table table-sm table-bordered align-middle mb-0" style="font-size:.83rem;min-width:700px">
                            ...
                            <tbody id="scheduleRowsContainer">
                                <?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="pw-schedule-row" data-schedule-row="<?php echo e($course->id); ?>">
                                    ...
                                    <td>
                                        <select class="form-select form-select-sm hari-select" data-course-id="<?php echo e($course->id); ?>" style="min-width:88px">
                                            <option value="">Pilih…</option>
                                    ...
                                    <td>
                                        <input type="time" class="form-control form-control-sm jam-mulai-input" data-course-id="<?php echo e($course->id); ?>" style="min-width:100px">
                                    </td>
                                    <td>
                                        <input type="time" class="form-control form-control-sm jam-selesai-input" data-course-id="<?php echo e($course->id); ?>" style="min-width:100px">
                                    </td>
                                    <td>
...
const _roomsList = <?php echo json_encode($rooms->map(fn($r) => ['id' => $r->id, 'nama' => $r->nama_ruangan, 'kapasitas' => $r->kapasitas])) ?>;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Edu Juanda Pratama\Downloads\smart-center-indonesia-1\smart-center-indonesia-1\resources\views/admin/registration/process.blade.php ENDPATH**/ ?>