        ...
        <div class="d-flex align-items-center gap-3">
            ...
            <div>
                ...
                <div style="font-size:12px;opacity:.8">
                    <?php echo e($schedule->paket?->nama ?? '—'); ?> — Sesi ke-<?php echo e($schedule->pertemuan_ke); ?>
            ...
            <div id="paketInfoBox" style="<?php echo e($schedule->paket ? '' : 'display:none'); ?>">
                <div class="p-3 rounded-3" style="background:var(--soft-primary-bg);border:1.5px solid var(--soft-primary-border)">
                    ...
                    <div class="row g-2 small" id="paketInfoContent">
                        ...
                        <div class="col-6"><span class="text-muted">Total Sesi:</span> <strong><?php echo e($schedule->paket->jumlah_pertemuan ?? '—'); ?></strong></div>
...
const CURRENT_SESI       = <?php echo e($schedule->pertemuan_ke ?? 'null'); ?>;
