            ...
            <div>
                ...
                <p style="opacity:.65;margin:0;font-size:13px">
                    <?php if($teacher): ?>
                        ...
                        <?php echo e(is_array($teacher->subjects) ? implode(', ', $teacher->subjects) : ($teacher->subjects ?? '-')); ?>
        ...
        <div class="stat-card" style="border-top:3px solid #c84ddf">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    ...
                    <div class="stat-value text-primary"><?php echo e($classes->count()); ?></div>
        ...
        <div class="stat-card" style="border-top:3px solid #10b981">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    ...
                    <div class="stat-value text-success"><?php echo e($classes->sum(fn($c) => $c->siswa->count())); ?></div>
            ...
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    ...
                    <div class="stat-value" style="color:#e09000">
                        <?php echo e($classes->pluck('mata_pelajaran_id')->unique()->count()); ?>
            ...
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    ...
                    <div class="stat-value" style="color:#0284c7">
                        <?php echo e($teacher?->branch?->name ?? '—'); ?>
...
<div class="dashboard-card fade-up">
    ...
    <div class="table-responsive">
        <table class="table table-hover align-middle mb-0">
            ...
            <tbody>
                <?php $__currentLoopData = $classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex align-items-center gap-3">
                            <div style="width:38px;height:38px;border-radius:10px;background:<?php echo e($clr); ?>18;display:flex;align-items:center;justify-content:center;flex-shrink:0">
                                <i class="bi bi-diagram-3-fill" style="color:<?php echo e($clr); ?>;font-size:15px"></i>
                            </div>
                            <div>
                                <div class="fw-semibold" style="font-size:13.5px"><?php echo e($c->nama_kelas); ?></div>
                                <?php if($c->jenis ?? null): ?>
                                <div class="text-muted" style="font-size:11px"><?php echo e(ucfirst($c->jenis)); ?></div>
                                <?php endif; ?>
                            </div>
                        </div>
                    </td>
                    <td class="d-none d-md-table-cell">
                        <span class="badge" style="background:var(--soft-primary-bg);color:var(--soft-primary-text);border:1px solid var(--soft-primary-border);font-size:11.5px;padding:4px 10px;border-radius:7px">
                            <i class="bi bi-journal-bookmark me-1"></i><?php echo e($c->mataPelajaran->nama ?? '–'); ?>
                    ...
                    <td class="d-none d-lg-table-cell">
                        <span class="badge" style="background:var(--input-bg);color:var(--text-muted);border:1px solid var(--card-border);font-size:11px;padding:4px 10px;border-radius:7px">
                            <i class="bi bi-building me-1"></i><?php echo e($c->cabang->name ?? 'Pusat'); ?>

                        </span>
                    </td>
                    <td class="text-center">
                        <span class="fw-bold" style="font-size:16px;color:var(--text-primary)"><?php echo e($siswaCnt); ?></span>
                        <div class="text-muted" style="font-size:10px">siswa</div>
                    </td>
                    <td class="text-center">
                        <div class="d-flex gap-2 justify-content-center">
                            <a href="<?php echo e(route('guru.classes.show', $c->id)); ?>"
                               class="btn btn-sm"
                               title="Detail Kelas"
                            ...
                            <a href="<?php echo e(route('guru.classes.attendance', $c->id)); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/runner/workspace/resources/views/guru/classes/index.blade.php ENDPATH**/ ?>