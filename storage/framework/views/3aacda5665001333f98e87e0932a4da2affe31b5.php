            ...
            <tbody>
                ...
                <tr style="border-bottom:1px solid var(--card-border);transition:background .15s<?php echo e($isToday ? ';background:rgba(104,17,126,.03)' : ''); ?>">
                    ...
                    <td class="d-none d-md-table-cell">
                        <div style="font-size:12.5px"><?php echo e($sc->guru?->name ?? $sc->paket?->guru?->name ?? '–'); ?></div>
                    </td>
                    ...
                    <td class="text-center">
                        <div class="d-flex justify-content-center gap-1">
                            ...
                            <button onclick="deleteSchedule(<?php echo e($sc->id); ?>, '<?php echo e(addslashes($sc->paket?->nama ?? 'Jadwal ini')); ?>')" class="btn btn-sm btn-act-del" title="Hapus"><i class="bi bi-trash-fill"></i></button>
                        </div>
                    </td>
                </tr>
