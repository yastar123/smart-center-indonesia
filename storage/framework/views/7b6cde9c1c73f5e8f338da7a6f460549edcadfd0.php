<?php $__env->startSection('title','Video Call'); ?>
<?php $__env->startSection('page-title','Video Call Online'); ?>
...
<div class="row g-3 mb-4">
    ...
    <div class="col-6 col-md-3">
        <div class="dashboard-card h-100" style="border-top:3px solid <?php echo e($t['color']); ?>">
            <div style="width:40px;height:40px;border-radius:10px;background:<?php echo e($t['bg']); ?>;display:flex;align-items:center;justify-content:center;margin-bottom:12px"><i class="bi <?php echo e($t['icon']); ?>" style="color:<?php echo e($t['color']); ?>;font-size:18px"></i></div>
            <div class="fw-semibold mb-1" style="font-size:13px"><?php echo e($t['title']); ?></div>
            <div class="text-muted" style="font-size:12px"><?php echo e($t['desc']); ?></div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/runner/workspace/resources/views/admin/videocall/index.blade.php ENDPATH**/ ?>