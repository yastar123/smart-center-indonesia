            ...
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    ...
                    <div class="stat-value" style="color:#e09000;font-size:16px">
                        <?php echo e(now()->month <= 6 ? 'Genap' : 'Ganjil'); ?>

                    </div>
                    <div class="stat-label text-muted" style="font-size:11px">
                        <i class="bi bi-calendar me-1"></i><?php echo e(now()->format('Y')); ?>
        ...
        <div class="stat-card" style="border-top:3px solid #0284c7">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    ...
                    <div class="stat-label text-muted" style="font-size:11px">
                        <i class="bi bi-calendar-week me-1"></i><?php echo e(now()->format('Y')); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Edu Juanda Pratama\Downloads\smart-center-indonesia\smart-center-indonesia\resources\views/siswa/attendance/index.blade.php ENDPATH**/ ?>