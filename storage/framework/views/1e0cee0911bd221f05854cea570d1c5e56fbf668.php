...
<section class="hero" id="home">
    ...
    <div class="hero-inner">
        <div class="hero-badge">
            ...
            <?php echo e($ls('hero.badge_text','Bimbel & Kursus Terbaik #1 di Indonesia')); ?>

        </div>

        <h1 class="hero-title">
            <?php echo e($ls('hero.title_line1','Wujudkan Mimpi,')); ?><br><span class="gradient-text"><?php echo e($ls('hero.title_line2','Raih Prestasi!')); ?></span>
        </h1>

        <p class="hero-desc">
            <?php echo e($ls('hero.description','Smart Center Indonesia — lembaga bimbingan belajar, kursus, dan les privat berbasis offline & online. Tutor profesional, metode modern, hasil terukur untuk semua jenjang dari TK hingga umum.')); ?>
    ...
    <div class="float-card float-card-1">
        <div class="float-card-content">
            ...
            <div class="float-card-text">
                <div class="fc-val"><?php echo e($ls('hero.float1_title','Nilai Naik!')); ?></div>
                <div class="fc-lab"><?php echo e($ls('hero.float1_subtitle','Rata-rata +30 poin · Bulan ini')); ?></div>
            </div>
        </div>
    </div>
    ...
    <div class="float-card float-card-2">
        <div class="float-card-content">
            ...
            <div class="float-card-text">
                <div class="fc-val"><?php echo e($ls('hero.float2_title','Siswa Baru Daftar')); ?></div>
                <div class="fc-lab"><?php echo e($ls('hero.float2_subtitle','Les Privat · Baru saja')); ?></div>
            </div>
        </div>
    </div>
