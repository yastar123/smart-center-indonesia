...
<nav class="sidebar" id="sidebar">
    ...
    <div class="sidebar-nav">
        ...
        <div class="nav-item">
            <a href="<?php echo e(route('owner.subject.index')); ?>" class="nav-link <?php echo e(request()->routeIs('owner.subject.*') ? 'active' : ''); ?>" data-label="Mata Pelajaran">
                <i class="bi bi-journal-bookmark-fill"></i>
                <span>Mata Pelajaran</span>
            </a>
        </div>
        <div class="nav-item">
            <a href="<?php echo e(route('owner.course-package.index')); ?>" class="nav-link <?php echo e(request()->routeIs('owner.course-package.*') ? 'active' : ''); ?>" data-label="Paket Belajar">
                <i class="bi bi-box-seam"></i>
                <span>Paket Belajar</span>
            </a>
        </div>
        <div class="nav-item">
            <a href="<?php echo e(route('owner.module.index')); ?>" class="nav-link <?php echo e(request()->routeIs('owner.module.*') ? 'active' : ''); ?>" data-label="Modul Akademik">
                <i class="bi bi-journal-text"></i>
...
(function() {
    const cmdPages = [
        ...
        <?php if (\Illuminate\Support\Facades\Blade::check('role', 'owner')): ?>
        { label:'Modul Akademik', desc:'Kelola modul materi pelajaran', href:'<?php echo e(route("owner.module.index")); ?>', icon:'bi-layers', color:'#68117e', group:'Akademik' },
        { label:'Paket Kursus', desc:'Paket belajar & harga kursus', href:'<?php echo e(route("owner.course-package.index")); ?>', icon:'bi-collection', color:'#059669', group:'Akademik' },
        { label:'Mata Pelajaran (Subject)', desc:'Kelola bidang studi', href:'<?php echo e(route("owner.subject.index")); ?>', icon:'bi-journal-text', color:'#10b981', group:'Akademik' },
        <?php endif; ?>
        ...
        { label:'Registrasi Siswa Baru', desc:'Daftarkan siswa & buat paket', href:'<?php echo e(route("admin.registration-list.create")); ?>', icon:'bi-person-plus', color:'#c84ddf', group:'Akademik' },
