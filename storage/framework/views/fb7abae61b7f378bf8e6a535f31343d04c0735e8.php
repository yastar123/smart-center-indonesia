...
function toggleSchoolData() {
    ...
    if (schoolNameLabel) {
        schoolNameLabel.textContent = selected === 'Mahasiswa' ? 'Nama Perguruan Tinggi' : 'Nama Sekolah';
    }
    if (schoolNameInput) {
        schoolNameInput.placeholder = selected === 'Mahasiswa' ? 'Nama perguruan tinggi' : 'Nama sekolah';
    }
}
