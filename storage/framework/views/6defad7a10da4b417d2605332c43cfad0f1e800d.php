        ...
        <div class="stat-card" style="border-top:3px solid #c84ddf">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    ...
                    <div class="stat-value text-primary" data-auto-count="<?php echo e($totalInvoices); ?>"><?php echo e($totalInvoices); ?></div>
        ...
        <div class="stat-card" style="border-top:3px solid #10b981">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    ...
                    <div class="stat-value text-success" data-auto-count="<?php echo e($lunasCount); ?>"><?php echo e($lunasCount); ?></div>
        ...
        <div class="stat-card" style="border-top:3px solid #f6af23">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    ...
                    <div class="stat-value text-warning" data-auto-count="<?php echo e($sebagianCount); ?>"><?php echo e($sebagianCount); ?></div>
        ...
        <div class="stat-card" style="border-top:3px solid #ef4444">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    ...
                    <div class="stat-value" style="color:#dc2626" data-auto-count="<?php echo e($menungguCount); ?>"><?php echo e($menungguCount); ?></div>
...
<div class="dashboard-card fade-up">
    <div class="d-flex align-items-center justify-content-between mb-3">
        <h6 class="fw-bold mb-0" style="font-size:14px">
            ...
            <span class="badge ms-2" style="background:var(--soft-primary-bg);color:var(--soft-primary-text);font-size:11px"><?php echo e($totalInvoices); ?> invoice</span>
        </h6>
    </div>
    ...
    <div class="table-responsive">
        <table class="table table-modern align-middle mb-0" style="min-width:780px">
            ...
            <tbody>
                ...
                ?>
                <tr style="border-bottom:1px solid var(--card-border);vertical-align:middle<?php echo e($isOverdue ? ';background:rgba(239,68,68,.03)' : ''); ?>">

                    
                    <td class="ps-3">
                        <div class="fw-bold" style="font-size:13px;font-family:monospace;color:var(--text-primary)">
                            <?php echo e($inv->nomor_invoice ?? '—'); ?>

                        </div>
                        <div class="text-muted mt-1" style="font-size:11px">
                            <i class="bi bi-calendar3 me-1"></i>
                            <?php echo e($inv->created_at?->format('d M Y') ?? '—'); ?>
                        ...
                        <?php elseif($inv->jatuh_tempo && $inv->status !== 'lunas'): ?>
                    ...
                    <td>
                        <div class="fw-semibold" style="font-size:13px;color:var(--text-primary)"><?php echo e($paketLabel); ?></div>
                        <?php if($subjectName): ?>
                        <div class="text-muted" style="font-size:11px;margin-top:2px"><?php echo e($subjectName); ?></div>
                        <?php endif; ?>
                        <?php if($metodeLabel): ?>
                        <div class="mt-1">
                            <span style="font-size:10px;background:var(--soft-info-bg);color:var(--soft-info-text);padding:2px 8px;border-radius:5px;font-weight:600">
                                <?php echo e($metodeLabel); ?>

                            </span>
                        </div>
                        <?php elseif($inv->status === 'belum_bayar' && !$isPending): ?>
                        <div class="mt-1">
                    ...
                    <td>
                        <div class="fw-bold" style="font-size:14px;color:<?php echo e($inv->status==='lunas' ? 'var(--soft-success-text)' : 'var(--text-primary)'); ?>">
                            Rp <?php echo e(number_format($inv->total, 0, ',', '.')); ?>

                        </div>
                        <?php if($inv->status === 'sebagian' && $sisa > 0): ?>
                    ...
                    <td>
                        <span style="background:<?php echo e($statusInfo['bg']); ?>;color:<?php echo e($statusInfo['color']); ?>;padding:5px 11px;border-radius:8px;font-size:11px;font-weight:600;white-space:nowrap;display:inline-flex;align-items:center;gap:5px">
                            <i class="bi <?php echo e($statusInfo['icon']); ?>" style="font-size:11px"></i><?php echo e($statusInfo['label']); ?>
                        ...
                        ?>
                        <div class="text-muted mt-1" style="font-size:10px">Cicilan <?php echo e($totalCicilan); ?>/<?php echo e($inv->pembayaran->count() ?: '?'); ?></div>
                        <?php endif; ?>
                    </td>
                    ...
                    <td class="text-center">
                        <?php if($inv->status === 'lunas'): ?>
                            <a href="<?php echo e(route('siswa.billing.invoice-detail', $inv->id)); ?>"
...
<?php $unpaidInvoices = $invoices->where('status','belum_bayar')->filter(fn($i) => $i->pembayaran->where('status','pending')->isEmpty()); ?>
...
<div class="dashboard-card fade-up mt-4">
    ...
    <div class="d-flex flex-column gap-2">
        <?php $__currentLoopData = $unpaidInvoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="d-flex align-items-center justify-content-between p-3 rounded-3"
             style="background:var(--input-bg);border:1.5px solid var(--soft-danger-border,#fecaca)">
            <div style="min-width:0">
                <div class="fw-semibold text-truncate" style="font-size:13px"><?php echo e($inv->nomor_invoice); ?></div>
                <div class="text-muted" style="font-size:12px">
                    Rp <?php echo e(number_format($inv->total, 0, ',', '.')); ?>

                    <?php if($inv->jatuh_tempo): ?> · Jatuh tempo <?php echo e($inv->jatuh_tempo->format('d M Y')); ?> <?php endif; ?>
                </div>
            </div>
            <a href="<?php echo e(route('siswa.billing.invoice-detail', $inv->id)); ?>"
