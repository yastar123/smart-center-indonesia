            ...
            <div class="mb-3" style="border:1px solid var(--card-border);border-radius:14px;overflow:hidden">
                ...
                <div class="p-3">
                    ...
                    <div id="scheduleRowsContainer">
                        <?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="pw-schedule-row mb-2" data-schedule-row="<?php echo e($course->id); ?>">
                            <div class="row g-2 align-items-center">
                                <div class="col-md-3">
                                    <span class="badge rounded-pill" style="background:rgba(200,77,223,.12);color:#461256;font-size:.75rem;font-weight:600;padding:.35em .8em"><?php echo e($course->nama); ?></span>
                                </div>
                                <div class="col-md-2">
                                ...
                                <div class="col-md-2">
                                    <input type="time" class="form-control form-control-sm jam-mulai-input" data-course-id="<?php echo e($course->id); ?>">
                                </div>
                                <div class="col-md-2">
                                    <input type="time" class="form-control form-control-sm jam-selesai-input" data-course-id="<?php echo e($course->id); ?>">
                                </div>
                                <div class="col-md-3">
                                    <div class="conflict-warning-box" data-course-id="<?php echo e($course->id); ?>" style="font-size:.72rem"></div>
                                </div>
                            </div>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
