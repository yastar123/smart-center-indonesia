...
<div class="error-card">
    ...
    <div class="error-body text-center">
        ...
        <div class="mt-3">
            <a href="<?php echo e(url('/login')); ?>" style="color:#c84ddf;font-size:13px;text-decoration:none;font-weight:600">
...
<?php /**PATH /home/runner/workspace/resources/views/errors/419.blade.php ENDPATH**/ ?>