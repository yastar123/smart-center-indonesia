...
<ul class="nav nav-pills mb-4 gap-2 fade-up" id="tagihanTab">
    <li class="nav-item">
        <button class="nav-link <?php echo e(!request('tab') || request('tab')=='kelas' ? 'active' : ''); ?>"
...
<div id="pane-kelas" class="<?php echo e(request('tab')=='registrasi' ? 'd-none' : ''); ?>">
    ...
    <div class="dashboard-card fade-up">
        ...
        <div class="d-flex justify-content-between align-items-center px-3 py-2 border-top">
            <div class="text-muted" style="font-size:13px">Menampilkan <?php echo e($classes->firstItem()); ?>–<?php echo e($classes->lastItem()); ?> dari <?php echo e($classes->total()); ?> kelas</div>
...
<div id="pane-registrasi" class="<?php echo e(request('tab')=='registrasi' ? '' : 'd-none'); ?>">
    ...
    <div class="dashboard-card mb-4 fade-up">
        <form method="GET" action="<?php echo e(route('admin.tagihan-siswa.index')); ?>">
            ...
            <div class="row g-2 align-items-end">
                ...
                <div class="col-md-2 d-flex gap-2">
                    <button type="submit" class="btn btn-primary flex-fill fw-semibold">Filter</button>
                    <a href="<?php echo e(route('admin.tagihan-siswa.index', ['tab'=>'registrasi'])); ?>" class="btn btn-outline-secondary px-3">Reset</a>
                </div>
            </div>
        </form>
    </div>
    ...
    <div class="dashboard-card fade-up">
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    ...
                    <?php $sc = $statusMap[$inv->status] ?? ['rgba(100,116,139,.1)','#64748b',$inv->status]; ?>
                    <tr>
                        <td>
                            <span style="font-size:11px;font-family:monospace;color:var(--text-muted)"><?php echo e($inv->nomor_invoice); ?></span>
                        </td>
                        <td>
                        ...
                        <td style="font-size:12px;max-width:220px">
                            <span class="text-muted" style="white-space:normal"><?php echo e($inv->deskripsi); ?></span>
                        </td>
                        <td>
                            <span class="fw-bold" style="font-size:14px">Rp <?php echo e(number_format($inv->total, 0, ',', '.')); ?></span>
                        </td>
                        <td style="font-size:12px">
                            <?php echo e($inv->jatuh_tempo ? \Carbon\Carbon::parse($inv->jatuh_tempo)->isoFormat('D MMM YYYY') : '—'); ?>

                        </td>
                        <td style="font-size:12px"><?php echo e($inv->cabang?->name ?? '—'); ?></td>
                        <td class="text-center">
                            <span class="fw-semibold" style="background:<?php echo e($sc[0]); ?>;color:<?php echo e($sc[1]); ?>;padding:3px 12px;border-radius:20px;font-size:11px">
                                <?php echo e($sc[2]); ?>
        ...
        <div class="d-flex justify-content-between align-items-center px-3 py-2 border-top">
            <div class="text-muted" style="font-size:13px">Menampilkan <?php echo e($registrationInvoices->firstItem()); ?>–<?php echo e($registrationInvoices->lastItem()); ?> dari <?php echo e($registrationInvoices->total()); ?> invoice</div>
