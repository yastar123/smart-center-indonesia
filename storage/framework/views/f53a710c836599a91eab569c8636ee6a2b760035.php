                        ...
                        <div class="col-12">
                            ...
                            <select id="class_id" name="class_id" class="form-select" style="border-radius:10px" required onchange="onClassChange(this.value)">
                                ...
                                <option value="<?php echo e($c->id); ?>"
                                    ...
                                    <?php echo e($c->nama_kelas); ?> — <?php echo e($c->mataPelajaran?->nama ?? ''); ?>
...
function saveProposal() {
    ...
    $.ajax({
        url: '<?php echo e(route('guru.schedule-agreements.store')); ?>',
        method: 'POST',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/runner/workspace/resources/views/guru/schedule-agreements/index.blade.php ENDPATH**/ ?>