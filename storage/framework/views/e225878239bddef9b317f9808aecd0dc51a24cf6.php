...
<nav class="lp-nav">
    <div class="nav-inner">
        ...
        <div class="d-flex align-items-center gap-2">
            <a href="<?php echo e(url('/')); ?>" class="btn-nav-login"><i class="bi bi-house me-1"></i>Beranda</a>
            <a href="<?php echo e(route('login')); ?>" class="btn-nav-register">Masuk</a>
        </div>
    </div>
</nav>
...
<div class="filter-bar">
    <div class="container">
        <div class="d-flex align-items-center gap-2">
            <a href="<?php echo e(route('articles.index')); ?>" class="kat-pill <?php echo e(!request('kategori') ? 'active' : ''); ?>">Semua</a>
            <?php $__currentLoopData = ['tips'=>'Tips & Trik','berita'=>'Berita','akademik'=>'Akademik','promo'=>'Promo','lainnya'=>'Lainnya']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $l): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <a href="<?php echo e(route('articles.index', ['kategori' => $k])); ?>" class="kat-pill <?php echo e(request('kategori') === $k ? 'active' : ''); ?>"><?php echo e($l); ?></a>
...
<div class="container" style="padding-top:2.5rem;padding-bottom:2rem">
    ...
    <div class="empty-state">
        ...
        <a href="<?php echo e(url('/')); ?>" class="btn btn-outline-secondary mt-2 rounded-pill">Kembali ke Beranda</a>
    </div>
    <?php else: ?>
    <div class="articles-grid">
        ...
        <a href="<?php echo e(route('articles.show', $a->slug)); ?>" class="art-card">
            <div class="art-thumb">
                <img src="<?php echo e($a->thumbnail_url); ?>" alt="<?php echo e($a->judul); ?>" loading="lazy">
                <span class="art-kat" style="background:<?php echo e($katColor[$a->kategori]); ?>"><?php echo e($katLabel[$a->kategori]); ?></span>
            </div>
            <div class="art-body">
                <div class="art-title"><?php echo e($a->judul); ?></div>
                <?php if($a->ringkasan): ?>
                <div class="art-desc"><?php echo e($a->ringkasan); ?></div>
                <?php endif; ?>
                <div class="art-meta">
                    <span><i class="bi bi-person me-1"></i><?php echo e($a->penulis?->name ?? '–'); ?></span>
                    <span><i class="bi bi-calendar3 me-1"></i><?php echo e($a->published_at?->translatedFormat('d M Y') ?? '–'); ?></span>
                    <span><i class="bi bi-eye me-1"></i><?php echo e($a->views); ?></span>
                </div>
            </div>
        </a>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="d-flex justify-content-center mt-5"><?php echo e($articles->appends(request()->query())->links()); ?></div>
    <?php endif; ?>
    <?php endif; ?>
</div>

<div class="mini-footer">&copy; <?php echo e(date('Y')); ?> Smart Center Indonesia. All Rights Reserved.</div>
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js"></script>
</body>
</html>
<?php /**PATH /home/runner/workspace/resources/views/articles/index.blade.php ENDPATH**/ ?>