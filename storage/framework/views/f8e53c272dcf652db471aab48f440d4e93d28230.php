<?php $__env->startSection('page-title', 'Kelola Landing Page'); ?>
    ...
    <div class="dashboard-card mb-4 fade-up" style="background:linear-gradient(135deg,#260632 0%,#461256 50%,#c84ddf 100%);color:white;border:none;overflow:hidden;position:relative">
        ...
        <div class="row align-items-center g-3" style="position:relative">
            ...
            <div class="col-md-4 text-md-end">
                <a href="<?php echo e(url('/')); ?>" target="_blank" class="btn fw-semibold px-4"
    ...
    <div class="tab-content">
                    ...
                    <form action="<?php echo e(route('admin.landing.settings.update')); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <input type="text" name="settings[hero.badge_text]" class="form-control" value="<?php echo e($settings['hero.badge_text']->value ?? 'Bimbel & Kursus Terbaik #1 di Indonesia'); ?>">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label fw-semibold">Judul Baris 1</label>
                                <input type="text" name="settings[hero.title_line1]" class="form-control" value="<?php echo e($settings['hero.title_line1']->value ?? 'Wujudkan Mimpi,'); ?>">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label fw-semibold">Judul Baris 2 <small class="text-primary">(tampil gradien emas)</small></label>
                                <input type="text" name="settings[hero.title_line2]" class="form-control" value="<?php echo e($settings['hero.title_line2']->value ?? 'Raih Prestasi!'); ?>">
                            </div>
                            <div class="col-12">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="settings[hero.float1_title]" class="form-control" value="<?php echo e($settings['hero.float1_title']->value ?? ''); ?>">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Float Card 1 — Subjudul</label>
                                <input type="text" name="settings[hero.float1_subtitle]" class="form-control" value="<?php echo e($settings['hero.float1_subtitle']->value ?? ''); ?>">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Float Card 2 — Judul</label>
                                <input type="text" name="settings[hero.float2_title]" class="form-control" value="<?php echo e($settings['hero.float2_title']->value ?? ''); ?>">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Float Card 2 — Subjudul</label>
                                <input type="text" name="settings[hero.float2_subtitle]" class="form-control" value="<?php echo e($settings['hero.float2_subtitle']->value ?? ''); ?>">
                            </div>
                    ...
                    <form action="<?php echo e(route('admin.landing.settings.update')); ?>" method="POST">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="settings[stats.years_exp]" class="form-control" value="<?php echo e($settings['stats.years_exp']->value ?? '14+'); ?>" placeholder="14+">
                                <small class="text-muted">Contoh: 14+</small>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label fw-semibold">% Kepuasan Pelanggan</label>
                                <input type="text" name="settings[stats.satisfaction]" class="form-control" value="<?php echo e($settings['stats.satisfaction']->value ?? '98%'); ?>" placeholder="98%">
        ...
        <div class="tab-pane fade" id="tab-programs">
            ...
            <div class="card lp-card mb-4">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('admin.landing.programs.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="row g-3">
                            <div class="col-md-6">
            ...
            <div class="card lp-card">
                <div class="card-header lp-card-header"><i class="bi bi-list-ul me-2"></i>Daftar Program (<?php echo e($programs->count()); ?>)</div>
                <div class="card-body p-0">
                    ...
                    <div class="lp-list-item">
                        <div class="d-flex align-items-start gap-3 flex-grow-1">
                            <div class="lp-emoji-icon"><?php echo e($prog->icon_emoji ?: '📖'); ?></div>
                            <div class="flex-grow-1">
                                <div class="d-flex align-items-center gap-2 mb-1">
                                    <strong><?php echo e($prog->title); ?></strong>
                                    <span class="badge" style="background:<?php echo e($prog->badge_bg); ?>;color:<?php echo e($prog->badge_color); ?>;border:1px solid <?php echo e($prog->badge_color); ?>20"><?php echo e($prog->badge_label); ?></span>
                                    <?php if($prog->is_popular): ?><span class="badge bg-warning text-dark">Populer</span><?php endif; ?>
                                    <?php if($prog->is_new): ?><span class="badge bg-success">Baru</span><?php endif; ?>
                                    <?php if(!$prog->is_active): ?><span class="badge bg-secondary">Non-aktif</span><?php endif; ?>
                                </div>
                                <div class="text-muted small"><?php echo e(Str::limit($prog->description, 100)); ?></div>
                            </div>
                        </div>
                        <div class="lp-item-actions">
                            <button class="btn btn-sm btn-outline-primary" onclick="openEditProgram(<?php echo e($prog->id); ?>)"><i class="bi bi-pencil"></i></button>
                            <form action="<?php echo e(route('admin.landing.programs.destroy', $prog)); ?>" method="POST" class="d-inline">
                                <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
        ...
        <div class="tab-pane fade" id="tab-testimonials">
            ...
            <div class="card lp-card">
                <div class="card-header lp-card-header"><i class="bi bi-chat-quote me-2"></i>Daftar Testimoni (<?php echo e($testimonials->count()); ?>)</div>
                <div class="card-body p-0">
                        ...
                        <div class="d-flex align-items-start gap-3 flex-grow-1">
                            ...
                            <div class="flex-grow-1">
                                <div class="d-flex align-items-center gap-2 mb-1">
                                    ...
                                    <span class="text-muted small">· <?php echo e($testi->role); ?></span>
                                    <?php if(!$testi->is_active): ?><span class="badge bg-secondary">Non-aktif</span><?php endif; ?>
                                </div>
                                <div class="text-muted small fst-italic"><?php echo e(Str::limit($testi->text, 120)); ?></div>
                            </div>
                        </div>
                        <div class="lp-item-actions">
                            <button class="btn btn-sm btn-outline-primary" onclick="openEditTesti(<?php echo e($testi->id); ?>)"><i class="bi bi-pencil"></i></button>
                            <form action="<?php echo e(route('admin.landing.testimonials.destroy', $testi)); ?>" method="POST" class="d-inline">
                                <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
                                <button type="button" class="btn btn-sm btn-outline-danger"
        ...
        <div class="tab-pane fade" id="tab-wa">
            ...
            <div class="card lp-card mb-4">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('admin.landing.wa.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="row g-3">
                            <div class="col-md-4">
            ...
            <div class="card lp-card">
                <div class="card-header lp-card-header" style="background:linear-gradient(135deg,#075e54,#25d366)">
                    <i class="bi bi-list-ul me-2"></i>Daftar Nomor WhatsApp (<?php echo e($waNumbers->count()); ?>)
                </div>
                <div class="card-body p-0">
                    <?php $__empty_1 = true; $__currentLoopData = $waNumbers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="lp-list-item">
                        <div class="wa-number-icon <?php echo e($wa->is_primary ? 'primary' : ''); ?>">
                            <i class="bi bi-whatsapp"></i>
                        </div>
                        <div class="flex-grow-1">
                            <div class="d-flex align-items-center gap-2 flex-wrap mb-1">
                                <strong><?php echo e($wa->label); ?></strong>
                                <?php if($wa->is_primary): ?>
                            ...
                            <div class="d-flex align-items-center gap-3">
                                <code class="wa-number-code">+<?php echo e($wa->number); ?></code>
                                <a href="https://wa.me/<?php echo e($wa->number); ?>" target="_blank" class="btn btn-xs text-success p-0" style="font-size:.78rem">
                                    <i class="bi bi-box-arrow-up-right me-1"></i>Buka WA
                                </a>
                            </div>
                            <?php if($wa->description): ?>
                                <div class="text-muted small mt-1"><?php echo e($wa->description); ?></div>
                            <?php endif; ?>
                        </div>
                        <div class="lp-item-actions">
                            <button class="btn btn-sm btn-outline-success" onclick="openEditWa(<?php echo e($wa->id); ?>)">
                                <i class="bi bi-pencil"></i>
                            </button>
                            <form action="<?php echo e(route('admin.landing.wa.destroy', $wa)); ?>" method="POST" class="d-inline">
                                <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
                                <button type="button" class="btn btn-sm btn-outline-danger"
                                        onclick="confirmAction('Hapus nomor <?php echo e(addslashes($wa->label)); ?>?', () => this.closest(\'form\').submit(), null, {title:\'Hapus Nomor WA\', okText:\'Ya, Hapus\'})">
                                    <i class="bi bi-trash"></i>
                                </button>
                            </form>
                        </div>
                    ...
                    <form action="<?php echo e(route('admin.landing.settings.update')); ?>" method="POST">
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <input type="text" name="settings[cta.eyebrow]" class="form-control" value="<?php echo e($settings['cta.eyebrow']->value ?? 'Mulai Sekarang'); ?>">
                            </div>
                            <div class="col-12">
                                <label class="form-label fw-semibold">Judul CTA</label>
                                <input type="text" name="settings[cta.title]" class="form-control" value="<?php echo e($settings['cta.title']->value ?? 'Wujudkan Mimpi Bersama SCI!'); ?>">
                            </div>
                            <div class="col-12">
                                <label class="form-label fw-semibold">Deskripsi CTA</label>
                                <textarea name="settings[cta.description]" class="form-control" rows="3"><?php echo e($settings['cta.description']->value ?? ''); ?></textarea>
                            </div>
                            <div class="col-12 text-end">
                    ...
                    <form action="<?php echo e(route('admin.landing.settings.update')); ?>" method="POST">
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <textarea name="settings[footer.brand_desc]" class="form-control" rows="3"><?php echo e($settings['footer.brand_desc']->value ?? ''); ?></textarea>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="settings[footer.instagram]" class="form-control" value="<?php echo e($settings['footer.instagram']->value ?? '#'); ?>" placeholder="https://instagram.com/...">
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="settings[footer.facebook]" class="form-control" value="<?php echo e($settings['footer.facebook']->value ?? '#'); ?>" placeholder="https://facebook.com/...">
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="settings[footer.youtube]" class="form-control" value="<?php echo e($settings['footer.youtube']->value ?? '#'); ?>" placeholder="https://youtube.com/...">
                                </div>
                            </div>
                            <div class="col-12 text-end">
        ...
        <div class="tab-pane fade" id="tab-galeri">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('admin.landing.settings.update')); ?>" method="POST">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                <label class="form-label fw-semibold">Judul Baris 1</label>
                                <input type="text" name="settings[galeri.title_line1]" class="form-control" value="<?php echo e($settings['galeri.title_line1']->value ?? 'Galeri'); ?>">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label fw-semibold">Judul Aksen <small class="text-primary">(tampil gradien)</small></label>
                                <input type="text" name="settings[galeri.title_accent]" class="form-control" value="<?php echo e($settings['galeri.title_accent']->value ?? 'Kegiatan'); ?>">
                            </div>
                            <div class="col-12">
                                <label class="form-label fw-semibold">Subjudul</label>
                                <textarea name="settings[galeri.subtitle]" class="form-control" rows="2"><?php echo e($settings['galeri.subtitle']->value ?? 'Momen belajar menyenangkan bersama siswa dan tutor terbaik SCI di seluruh Indonesia.'); ?></textarea>
                            </div>
                            <div class="col-12 text-end">
            ...
            <div class="card lp-card mb-4">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('admin.landing.galleries.store')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="row g-3">
                            <div class="col-12">
            ...
            <div class="card lp-card">
                <div class="card-header lp-card-header"><i class="bi bi-images me-2"></i>Foto Galeri (<?php echo e($galleries->count()); ?>)</div>
                <div class="card-body <?php echo e($galleries->isEmpty() ? '' : 'p-0'); ?>">
                    <?php $__empty_1 = true; $__currentLoopData = $galleries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="lp-list-item">
                        <?php if($gal->image): ?>
                        <img src="<?php echo e(str_starts_with($gal->image,'http') ? $gal->image : asset($gal->image)); ?>" style="width:90px;height:65px;object-fit:cover;border-radius:10px;flex-shrink:0">
                        <?php else: ?>
                        <div class="lp-emoji-icon"><i class="bi bi-image"></i></div>
                        <?php endif; ?>
                        <div class="flex-grow-1">
                            <div class="text-muted small"><?php echo e($gal->alt ?: '(tanpa keterangan)'); ?></div>
                            <div class="d-flex gap-2 mt-1 flex-wrap">
                                <?php if(!$gal->is_active): ?><span class="badge bg-secondary">Non-aktif</span><?php endif; ?>
                                <span class="badge" style="background:rgba(200,77,223,.1);color:#68117e">Urutan: <?php echo e($gal->sort_order); ?></span>
                            </div>
                        </div>
                        <div class="lp-item-actions">
                            <button class="btn btn-sm btn-outline-primary" onclick="openEditGallery(<?php echo e($gal->id); ?>)"><i class="bi bi-pencil"></i></button>
                            <form action="<?php echo e(route('admin.landing.galleries.destroy', $gal)); ?>" method="POST" class="d-inline">
                                <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
        ...
        <div class="tab-pane fade" id="tab-faq">
                    ...
                    <form action="<?php echo e(route('admin.landing.settings.update')); ?>" method="POST">
                        ...
                        <div class="row g-3">
                            <div class="col-md-4">
                                ...
                                <input type="text" name="settings[bantuan.eyebrow]" class="form-control" value="<?php echo e($settings['bantuan.eyebrow']->value ?? 'Bantuan & Kontak'); ?>">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label fw-semibold">Judul Baris 1</label>
                                <input type="text" name="settings[bantuan.title_line1]" class="form-control" value="<?php echo e($settings['bantuan.title_line1']->value ?? 'Pertanyaan &'); ?>">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label fw-semibold">Judul Aksen <small class="text-primary">(tampil gradien)</small></label>
                                <input type="text" name="settings[bantuan.title_accent]" class="form-control" value="<?php echo e($settings['bantuan.title_accent']->value ?? 'Hubungi Kami'); ?>">
                            </div>
                            <div class="col-12">
                                <label class="form-label fw-semibold">Subjudul</label>
                                <textarea name="settings[bantuan.subtitle]" class="form-control" rows="2"><?php echo e($settings['bantuan.subtitle']->value ?? 'Punya pertanyaan atau ingin bergabung? Kami siap membantu Anda kapan saja.'); ?></textarea>
                            </div>
                            <div class="col-12 text-end">
                                <button type="submit" class="btn btn-primary px-4"><i class="bi bi-save me-1"></i>Simpan Heading</button>
                            </div>
            ...
            <div class="card lp-card mb-4">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('admin.landing.faqs.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="row g-3">
                            <div class="col-12">
            ...
            <div class="card lp-card">
                <div class="card-header lp-card-header"><i class="bi bi-question-circle me-2"></i>Daftar FAQ (<?php echo e($faqs->count()); ?>)</div>
                <div class="card-body p-0">
                    ...
                    <div class="lp-list-item" style="align-items:flex-start">
                        ...
                        <div class="flex-grow-1">
                            <div class="d-flex align-items-center gap-2 mb-1">
                                ...
                                <?php if(!$faq->is_active): ?><span class="badge bg-secondary">Non-aktif</span><?php endif; ?>
                            </div>
                            <div class="text-muted small"><?php echo e(Str::limit($faq->answer, 120)); ?></div>
                        </div>
                        <div class="lp-item-actions">
                            <button class="btn btn-sm btn-outline-primary" onclick="openEditFaq(<?php echo e($faq->id); ?>)"><i class="bi bi-pencil"></i></button>
                            <form action="<?php echo e(route('admin.landing.faqs.destroy', $faq)); ?>" method="POST" class="d-inline">
                                <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
        ...
        <div class="tab-pane fade" id="tab-tutor">
            <div class="alert border-0 mb-4 d-flex align-items-start gap-3" style="background:rgba(200,77,223,.07);border-left:4px solid #c84ddf !important;border-radius:12px">
                ...
                <div>
                    ...
                    <div class="small text-muted">Data tutor (nama, foto, mata pelajaran) diambil otomatis dari <strong>Guru Aktif</strong> di sistem. Kelola data guru di menu <a href="<?php echo e(route('admin.teachers.index')); ?>" class="text-primary fw-semibold">Data Guru <i class="bi bi-arrow-up-right" style="font-size:.7rem"></i></a>. Di sini Anda bisa mengubah teks heading seksi ini saja.</div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('admin.landing.settings.update')); ?>" method="POST">
                        ...
                        <div class="row g-3">
                            <div class="col-md-4">
                                <label class="form-label fw-semibold">Eyebrow <small class="text-muted">(teks kecil atas)</small></label>
                                <input type="text" name="settings[tutor.eyebrow]" class="form-control" value="<?php echo e($settings['tutor.eyebrow']->value ?? 'Tim Pengajar'); ?>">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label fw-semibold">Judul Baris 1</label>
                                <input type="text" name="settings[tutor.title_line1]" class="form-control" value="<?php echo e($settings['tutor.title_line1']->value ?? 'Tutor'); ?>">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label fw-semibold">Judul Aksen <small class="text-primary">(gradien)</small></label>
                                <input type="text" name="settings[tutor.title_accent]" class="form-control" value="<?php echo e($settings['tutor.title_accent']->value ?? 'Terbaik'); ?>">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label fw-semibold">Judul Baris 2</label>
                                <input type="text" name="settings[tutor.title_line2]" class="form-control" value="<?php echo e($settings['tutor.title_line2']->value ?? 'Kami'); ?>">
                            </div>
                            <div class="col-md-8">
                                <label class="form-label fw-semibold">Subjudul</label>
                                <textarea name="settings[tutor.subtitle]" class="form-control" rows="2"><?php echo e($settings['tutor.subtitle']->value ?? 'Dilatih secara profesional dan berpengalaman di bidangnya masing-masing untuk memberikan hasil terbaik bagi setiap siswa.'); ?></textarea>
                            </div>
                            <div class="col-12 text-end">
                                <button type="submit" class="btn btn-primary px-4"><i class="bi bi-save me-1"></i>Simpan</button>
                            </div>
...
<script>
const programsData     = <?php echo json_encode($programs->keyBy('id'), 15, 512) ?>;
const testimonialsData = <?php echo json_encode($testimonials->keyBy('id'), 15, 512) ?>;
const waNumbersData    = <?php echo json_encode($waNumbers->keyBy('id'), 15, 512) ?>;
const tickersData      = <?php echo json_encode($tickers->keyBy('id'), 15, 512) ?>;
const featuresData     = <?php echo json_encode($features->keyBy('id'), 15, 512) ?>;
const jenjangsData     = <?php echo json_encode($jenjangs->keyBy('id'), 15, 512) ?>;
const trustsData       = <?php echo json_encode($trusts->keyBy('id'), 15, 512) ?>;
const highlightsData   = <?php echo json_encode($highlights->keyBy('id'), 15, 512) ?>;
const galleriesData    = <?php echo json_encode($galleries->keyBy('id'), 15, 512) ?>;
const faqsData         = <?php echo json_encode($faqs->keyBy('id'), 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Edu Juanda Pratama\Downloads\smart-center-indonesia-1 (1)\smart-center-indonesia-1\resources\views/admin/landing/index.blade.php ENDPATH**/ ?>