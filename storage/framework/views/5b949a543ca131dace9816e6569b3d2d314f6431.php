...
<div class="card-wrap">
    ...
    <div class="card-body-inner">
        ...
        <div class="d-flex align-items-center gap-2 mb-3 p-3 rounded-3" style="background:#fef2f2;border:1.5px solid #fecaca;color:#dc2626">
            ...
            <span style="font-size:.85rem"><?php echo e($errors->first()); ?></span>
        </div>
        <?php endif; ?>
        ...
        <form method="POST" action="<?php echo e(route('password.confirm')); ?>" id="confirmForm">
            <?php echo csrf_field(); ?>
...
$message = $__bag->first($__errorArgs[0]); ?>
                <div class="mt-1" style="font-size:.8rem;color:#ef4444"><?php echo e($message); ?></div>
                <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
        ...
        <div class="text-center mt-4" style="font-size:.875rem;color:#6b7280">
            <a href="<?php echo e(route('login')); ?>" class="d-inline-flex align-items-center gap-1 fw-semibold text-decoration-none" style="color:#c84ddf">
...
<?php /**PATH C:\Users\Edu Juanda Pratama\Downloads\smart-center-indonesia-1 (2)\smart-center-indonesia\resources\views/auth/confirm-password.blade.php ENDPATH**/ ?>