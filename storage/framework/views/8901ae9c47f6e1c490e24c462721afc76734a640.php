...
<?php $__env->startSection('page-title', 'Dashboard Owner'); ?>
        ...
        <div class="stat-card" style="border-top:3px solid #c84ddf">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    ...
                    <div class="stat-value text-primary"><?php echo e($activeBranches); ?></div>
                    <div class="stat-label text-muted" style="font-size:11px">
                        <i class="bi bi-building me-1"></i>dari <?php echo e($totalBranches); ?> total
                    </div>
                </div>
        ...
        <div class="stat-card" style="border-top:3px solid #10b981">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    ...
                    <div class="stat-value" style="color:#059669"><?php echo e($totalStudents); ?></div>
                    <div class="stat-label" style="font-size:11px;color:#059669">
                        <i class="bi bi-person-check me-1"></i><?php echo e($activeStudents); ?> aktif
                    </div>
                </div>
        ...
        <div class="stat-card" style="border-top:3px solid #f6af23">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    ...
                    <div class="stat-value" style="color:#e09000"><?php echo e($totalTeachers); ?></div>
                    <div class="stat-label text-muted" style="font-size:11px">
                        <i class="bi bi-person-badge me-1"></i><?php echo e($activeTeachers); ?> aktif
                    </div>
                </div>
            ...
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    ...
                    <div class="stat-label text-muted" style="font-size:11px">
                        ...
                        Total: Rp <?php echo e(number_format($totalRevenue, 0, ',', '.')); ?>
    ...
    <div class="col-lg-4 fade-up" style="animation-delay:.05s">
        <div class="dashboard-card h-100">
            ...
            <div class="d-grid gap-2">
                ...
                <a href="<?php echo e(route($lnk['route'])); ?>"
                   class="d-flex align-items-center gap-3 p-3 rounded-3 text-decoration-none quick-owner-link"
                   style="background:<?php echo e($lnk['bg']); ?>;border:1px solid <?php echo e($lnk['border']); ?>">
                    <div style="width:38px;height:38px;border-radius:10px;background:<?php echo e($lnk['color']); ?>;display:flex;align-items:center;justify-content:center;color:white;flex-shrink:0">
                        <i class="bi <?php echo e($lnk['icon']); ?>"></i>
                    </div>
                    <div style="min-width:0">
                        <div class="fw-semibold" style="font-size:13px;color:var(--text-primary)"><?php echo e($lnk['label']); ?></div>
                        <div style="font-size:11px;color:var(--text-muted)"><?php echo e($lnk['sub']); ?></div>
                    </div>
    ...
    <div class="col-lg-8 fade-up" style="animation-delay:.10s">
        <div class="dashboard-card h-100">
            ...
            <div class="text-center py-5">
                ...
                <a href="<?php echo e(route('owner.branches.index')); ?>" class="btn btn-sm btn-primary">
                ...
                <table class="table table-hover align-middle mb-0" style="font-size:13px">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="py-3">
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-muted d-md-none" style="font-size:11px"><?php echo e($b->city ?? '–'); ?></div>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="text-center d-none d-md-table-cell text-muted"><?php echo e($b->city ?? '–'); ?></td>
                            <td class="text-center">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/runner/workspace/resources/views/owner/dashboard.blade.php ENDPATH**/ ?>