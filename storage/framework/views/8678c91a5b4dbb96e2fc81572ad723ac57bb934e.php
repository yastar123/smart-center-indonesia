            ...
            <div class="d-flex flex-column gap-2 mt-3" style="font-size:12px">
                ...
                <div class="d-flex justify-content-between align-items-start">
                    ...
                    <span class="fw-semibold text-end" style="color:var(--soft-primary-text)">
                        <?php echo e($schedule->mataPelajaran?->nama ?? ($schedule->paket?->mataPelajaran->pluck('nama')->join(', ') ?? '—')); ?>
                ...
                <div class="d-flex justify-content-between align-items-start">
                    ...
                    <span class="fw-semibold text-end" style="font-size:12px"><?php echo e($schedule->paket->mataPelajaran->pluck('nama')->join(', ')); ?></span>
                </div>
                <?php endif; ?>
            </div>
            <?php else: ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Edu Juanda Pratama\Downloads\smart-center-indonesia-1 (2)\smart-center-indonesia\resources\views/admin/schedules/show.blade.php ENDPATH**/ ?>