...
<div class="container-fluid px-0">
    ...
    <?php $city = $branch->city ?: $branch->name; ?>
    ...
    <div class="alert border-0 mb-4 small" style="background:rgba(200,77,223,.06);border-left:4px solid #c84ddf !important;border-radius:12px">
        ...
        <strong>Paket &amp; harga</strong> dikelola di menu <a href="<?php echo e(route('admin.packages.index')); ?>">Paket</a>.
        <strong>Testimoni</strong> menggunakan testimoni global yang dikelola di <a href="<?php echo e(route('admin.landing.index')); ?>#tab-testimonials">Landing Utama → Testimoni</a>.
    </div>

    <form action="<?php echo e(route('admin.landing.cabang.update', $branch)); ?>" method="POST" id="branchLandingForm">
                    ...
                    <div class="card-body">
                        ...
                        <div id="promoList" class="d-flex flex-column gap-2 mb-3">
                            ...
                            <div class="promo-row d-flex align-items-center gap-2">
                                ...
                                <span class="badge bg-light text-muted fw-normal" style="font-size:.68rem;min-width:22px"><?php echo e($i+1); ?></span>
                                <input type="text" name="promo_items[]" value="<?php echo e($item); ?>"
                ...
                <div class="card lp-card">
                    ...
                    <div class="card-body">
                        <div class="alert border-0 mb-4" style="background:rgba(200,77,223,.06);border-left:3px solid #c84ddf !important;border-radius:10px;font-size:.83rem">
                            <i class="bi bi-info-circle me-1" style="color:var(--bs-primary)"></i>
                            Judul utama <strong>"Les Privat Terbaik di <?php echo e($city); ?>"</strong> diatur otomatis dari nama kota cabang.
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="hero_description" class="form-control" rows="4" maxlength="600"
                                          placeholder="Smart Center Indonesia hadir di <?php echo e($city); ?> dengan tutor bersertifikat..."><?php echo e($s['hero_description'] ?? 'Smart Center Indonesia hadir di '.$city.' dengan tutor bersertifikat. Layanan home visit, online, dan offline untuk semua jenjang dari TK hingga umum.'); ?></textarea>
                            ...
                            <div class="col-12">
                                <div class="p-3 rounded-3" style="background:linear-gradient(160deg,#1a0228 0%,#461256 45%,#6d1a7e 100%)">
                                    ...
                                    <div style="font-size:1.6rem;font-weight:900;color:white;line-height:1.1;margin-bottom:.5rem">
                                        Les Privat <em style="font-style:italic;color:#f6af23">Terbaik</em><br>di <?php echo e($city); ?>

                                    </div>
                                    <div style="font-size:.85rem;color:rgba(255,255,255,.7);max-width:400px" id="prevDesc"><?php echo e($s['hero_description'] ?? 'Smart Center Indonesia hadir di '.$city.' dengan tutor bersertifikat.'); ?></div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-4">
                                <div class="p-3 rounded-3 h-100" style="background:#f9f4ff;border:1.5px solid rgba(200,77,223,.15)">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group input-group-sm">
                                            ...
                                            <input type="text" name="price_homevisi" class="form-control price-input"
                                                   value="<?php echo e($s['price_homevisi'] ?? 'Rp 65.000'); ?>"
                                    ...
                                    <div class="price-preview-card p-2 rounded-2 text-center" style="background:white;border:1px solid rgba(200,77,223,.2)">
                                        ...
                                        <div class="fw-bold" style="color:#68117e;font-size:1.1rem" id="prevHomevisi"><?php echo e($s['price_homevisi'] ?? 'Rp 65.000'); ?></div>
                            ...
                            <div class="col-md-4">
                                <div class="p-3 rounded-3 h-100" style="background:#f9f4ff;border:1.5px solid rgba(200,77,223,.15)">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group input-group-sm">
                                            ...
                                            <input type="text" name="price_online" class="form-control price-input"
                                                   value="<?php echo e($s['price_online'] ?? 'Rp 50.000'); ?>"
                                    ...
                                    <div class="price-preview-card p-2 rounded-2 text-center" style="background:white;border:1px solid rgba(200,77,223,.2)">
                                        <div class="small text-muted">Mulai</div>
                                        <div class="fw-bold" style="color:#68117e;font-size:1.1rem" id="prevOnline"><?php echo e($s['price_online'] ?? 'Rp 50.000'); ?></div>
                                        <div class="small text-muted">/sesi</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="p-3 rounded-3 h-100" style="background:#f9f4ff;border:1.5px solid rgba(200,77,223,.15)">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group input-group-sm">
                                            ...
                                            <input type="text" name="price_offline" class="form-control price-input"
                                                   value="<?php echo e($s['price_offline'] ?? 'Rp 55.000'); ?>"
                                    ...
                                    <div class="price-preview-card p-2 rounded-2 text-center" style="background:white;border:1px solid rgba(200,77,223,.2)">
                                        <div class="small text-muted">Mulai</div>
                                        <div class="fw-bold" style="color:#68117e;font-size:1.1rem" id="prevOffline"><?php echo e($s['price_offline'] ?? 'Rp 55.000'); ?></div>
                                        <div class="small text-muted">/sesi</div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row g-3">
                                    <div class="col-12">
                                        ...
                                        <input type="text" name="hours_weekday" class="form-control"
                                               value="<?php echo e($s['hours_weekday'] ?? '08.00 – 20.00 WIB'); ?>"
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="text" name="hours_weekend" class="form-control"
                                               value="<?php echo e($s['hours_weekend'] ?? '09.00 – 16.00 WIB'); ?>"
                                        ...
                                        <div class="p-3 rounded-3" style="background:#f9f4ff;border:1.5px solid rgba(200,77,223,.15)">
                                            ...
                                            <div class="d-flex gap-2 align-items-start mb-1">
                                                ...
                                                <div class="small">
                                                    ...
                                                    <div class="text-muted">Senin – Sabtu: <span id="prevWeekday"><?php echo e($s['hours_weekday'] ?? '08.00 – 20.00 WIB'); ?></span></div>
                                                    <div class="text-muted">Minggu: <span id="prevWeekend"><?php echo e($s['hours_weekend'] ?? '09.00 – 16.00 WIB'); ?></span></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div id="faqList" class="d-flex flex-column gap-3 mb-4">
                            ...
                            <div class="faq-row border rounded-3 p-3" style="border-color:rgba(200,77,223,.15) !important;background:#fdf8ff">
                                <div class="d-flex align-items-start gap-2 mb-2">
                                    <span class="badge fw-bold mt-1" style="background:rgba(200,77,223,.1);color:#68117e;min-width:24px"><?php echo e($fi+1); ?></span>
                                    <div class="flex-grow-1">
                                        <label class="form-label small fw-semibold mb-1">Pertanyaan</label>
                                        <input type="text" name="faq_q[]" value="<?php echo e($faq['q']); ?>"
                                        ...
                                        <textarea name="faq_a[]" class="form-control form-control-sm" rows="3"
                                                  placeholder="Jawaban lengkap..." maxlength="1000"><?php echo e($faq['a']); ?></textarea>
                                    </div>
