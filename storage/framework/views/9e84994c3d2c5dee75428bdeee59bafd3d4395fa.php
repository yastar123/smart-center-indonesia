...
<div class="mb-4 fade-up">
    <a href="<?php echo e(route('owner.promo.show', $promo->id)); ?>" class="btn btn-sm"
...
<div class="mb-4 fade-up" style="animation-delay:.02s">
    <h5 class="fw-bold mb-1" style="color:var(--text-primary)">Edit Promo: <?php echo e($promo->judul); ?></h5>
    <p class="text-muted mb-0" style="font-size:13px">ID: <?php echo e($promo->kode); ?></p>
</div>

<form action="<?php echo e(route('owner.promo.update', $promo->id)); ?>" method="POST" enctype="multipart/form-data">
<?php echo csrf_field(); ?>
    ...
    <div class="col-lg-8">
        ...
        <div class="dashboard-card mb-4 fade-up" style="animation-delay:.04s">
            ...
            <div id="banner-drop" onclick="document.getElementById('banner-input').click()"
                ...
                <img id="banner-preview" src="<?php echo e(asset('storage/'.$promo->banner_path)); ?>" alt=""
...
unset($__errorArgs, $__bag); ?>"
                       value="<?php echo e(old('judul', $promo->judul)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-6 col-md-3">
                        <label class="tipe-card d-flex flex-column align-items-center gap-2 p-3 text-center"
                            ...
                            <input type="radio" name="tipe" value="<?php echo e($val); ?>" class="d-none"
                                   <?php echo e(old('tipe', $promo->tipe) === $val ? 'checked' : ''); ?>>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="kode_promo" class="form-control"
                       value="<?php echo e(old('kode_promo', $promo->kode_promo)); ?>" placeholder="KODEPROMO2026"
            ...
            <div>
                ...
                <textarea name="deskripsi" class="form-control" rows="3"
                          placeholder="Jelaskan keuntungan promo ini kepada siswa..."><?php echo e(old('deskripsi', $promo->deskripsi)); ?></textarea>
            </div>
        </div>
        ...
        <div class="dashboard-card fade-up" style="animation-delay:.08s">
            ...
            <div class="row g-3 mb-3">
                <div class="col-6">
                    ...
                    <input type="date" name="tanggal_mulai" class="form-control"
                           value="<?php echo e(old('tanggal_mulai', $promo->tanggal_mulai?->format('Y-m-d'))); ?>" required>
                </div>
                <div class="col-6">
                    ...
                    <input type="date" name="tanggal_berakhir" class="form-control"
                           value="<?php echo e(old('tanggal_berakhir', $promo->tanggal_berakhir?->format('Y-m-d'))); ?>" required>
                </div>
            </div>
                ...
                <div class="d-flex flex-column gap-2">
                    ...
                    <label class="target-item d-flex align-items-center gap-3 p-3"
                        ...
                        <input type="radio" name="target" value="<?php echo e($val); ?>"
                               <?php echo e(old('target', $promo->target) === $val ? 'checked' : ''); ?>
            ...
            <div id="cabang-row" style="<?php echo e(old('target', $promo->target) === 'cabang' ? '' : 'display:none'); ?>">
                <label class="form-label fw-semibold" style="font-size:13px">Pilih Cabang</label>
                <select name="cabang_id" class="form-select">
                    <option value="">— Pilih Cabang —</option>
                    <?php $__currentLoopData = $branches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($b->id); ?>" <?php echo e(old('cabang_id', $promo->cabang_id) == $b->id ? 'selected' : ''); ?>><?php echo e($b->name); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
        </div>
    ...
    <div class="col-lg-4">
        <div class="dashboard-card fade-up" style="animation-delay:.05s;position:sticky;top:80px">
            ...
            <div class="mb-4">
                <?php $__currentLoopData = ['draft'=>['Draft','#f6af23'],'aktif'=>['Aktif','#10b981'],'berakhir'=>['Berakhir','#64748b']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sv=>[$sl,$sc]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <label class="d-flex align-items-center gap-3 p-3 mb-2" style="border:1.5px solid var(--card-border);border-radius:12px;cursor:pointer">
                    <input type="radio" name="status" value="<?php echo e($sv); ?>" class="form-check-input mb-0"
                           <?php echo e(old('status', $promo->status) === $sv ? 'checked' : ''); ?>>
                    <div class="d-flex align-items-center gap-2">
                        <i class="bi bi-circle-fill" style="font-size:8px;color:<?php echo e($sc); ?>"></i>
                        <span class="fw-semibold" style="font-size:13px"><?php echo e($sl); ?></span>
                    </div>
                </label>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
            ...
            <a href="<?php echo e(route('owner.promo.show', $promo->id)); ?>" class="btn w-100 mt-2"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/runner/workspace/resources/views/owner/promo/edit.blade.php ENDPATH**/ ?>