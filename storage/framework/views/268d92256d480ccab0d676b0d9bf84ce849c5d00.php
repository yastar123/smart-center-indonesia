<?php $__env->startSection('title', 'Tambah Kurikulum & Silabus'); ?>
<?php $__env->startSection('page-title', 'Tambah Kurikulum & Silabus'); ?>
...
<form action="<?php echo e(route('owner.curriculum.store')); ?>" method="POST" enctype="multipart/form-data">
<?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-3">
                ...
                <div class="d-flex gap-3">
                    <label class="d-flex align-items-center gap-2 p-3 flex-1"
                           ...
                           id="lbl-global">
                        <input type="radio" name="scope" value="global" <?php echo e(old('scope','global') === 'global' ? 'checked' : ''); ?>
                    ...
                    <label class="d-flex align-items-center gap-2 p-3 flex-1"
                           style="border:1.5px solid var(--card-border);border-radius:12px;cursor:pointer;flex:1;transition:.15s"
                           id="lbl-lokal">
                        <input type="radio" name="scope" value="lokal" <?php echo e(old('scope') === 'lokal' ? 'checked' : ''); ?>
            ...
            <div class="mb-3" id="branch-row" style="<?php echo e(old('scope') === 'lokal' ? '' : 'display:none'); ?>">
    ...
    <div class="col-lg-8">
            ...
            <div id="chapters-container" class="d-flex flex-column gap-3">
                ...
                <div class="chapter-row p-3" style="border:1.5px solid var(--card-border);border-radius:14px;background:var(--input-bg)">
                    <div class="d-flex align-items-center gap-2 mb-3">
                        <div class="chapter-num fw-bold" style="width:28px;height:28px;border-radius:50%;background:linear-gradient(135deg,#461256,#c84ddf);color:white;display:flex;align-items:center;justify-content:center;font-size:13px;flex-shrink:0">1</div>
                        <div class="fw-semibold" style="font-size:13px;flex:1">Bab 1</div>
                    ...
                    <div class="row g-3">
                        <div class="col-8">
                            ...
                            <input type="text" name="chapters[0][judul]" class="form-control" placeholder="cth. Bab 1: Aljabar Dasar" required>
                        </div>
                        <div class="col-4">
                            <label class="form-label" style="font-size:12px;font-weight:600">Jumlah Sesi <span class="text-danger">*</span></label>
                            <input type="number" name="chapters[0][jumlah_sesi]" class="form-control" value="2" min="1" required>
                        </div>
                        <div class="col-12">
                            <label class="form-label" style="font-size:12px;font-weight:600">Upload PDF Silabus <span class="text-muted fw-normal">(opsional)</span></label>
                            <input type="file" name="chapters[0][pdf]" class="form-control" accept=".pdf">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="d-flex gap-3 mt-4 fade-up" style="animation-delay:.1s">
            <button type="submit" class="btn btn-primary fw-semibold px-5" style="border-radius:12px">
                <i class="bi bi-save me-2"></i>Simpan Kurikulum
            </button>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/runner/workspace/resources/views/owner/curriculum/create.blade.php ENDPATH**/ ?>