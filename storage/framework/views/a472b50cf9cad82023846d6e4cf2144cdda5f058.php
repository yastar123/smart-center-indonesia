...
<?php $__env->startSection('page-title', 'Registrasi Siswa Baru'); ?>
...
<div class="dashboard-card mb-4" style="background:linear-gradient(135deg,#260632 0%,#461256 50%,#c84ddf 100%);color:white;border:none;overflow:hidden;position:relative">
    ...
    <div class="d-flex align-items-center justify-content-between flex-wrap gap-3" style="position:relative">
        <div>
            ...
            <h4 class="fw-bold mb-1" style="color:white;font-size:clamp(16px,2vw,22px)">Registrasi Siswa Baru</h4>
            <p style="opacity:.72;margin:0;font-size:13px">Isi data siswa, paket kelas, mata pelajaran &amp; pembayaran &mdash; akun langsung dibuat dan siap dikirim ke WhatsApp.</p>
        </div>
...
<div class="dashboard-card p-0" style="overflow:hidden">
    ...
    <form id="wizardForm" class="pw-card">
        <?php echo csrf_field(); ?>
        ...
        <div class="pw-panel active" data-step="1">
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    <label class="form-label fw-semibold" style="font-size:.78rem">Nama Lengkap <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" name="name" required>
                </div>
                <div class="col-md-6">
                    <label class="form-label fw-semibold" style="font-size:.78rem">No. HP Siswa <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" name="phone" placeholder="08xxxxxxxxxx" required>
                </div>
                <div class="col-md-6">
                    <label class="form-label fw-semibold" style="font-size:.78rem">Jenis Kelamin <span class="text-danger">*</span></label>
                ...
                <div class="col-md-3">
                    <label class="form-label" style="font-size:.78rem;color:var(--text-muted)">Tanggal Lahir</label>
        ...
        <div class="pw-panel" data-step="3">
            ...
            <div class="alert alert-warning" style="font-size:.85rem"><i class="bi bi-exclamation-triangle me-2"></i>Belum ada mata pelajaran aktif di data master. Tambahkan mata pelajaran terlebih dahulu.</div>
            <?php else: ?>
                ...
                <div class="row g-2 align-items-center">
                    <div class="col-md-3">
                        <div class="form-check">
                            <input class="form-check-input course-check" type="checkbox" name="course_ids[]" value="<?php echo e($course->id); ?>" id="course<?php echo e($course->id); ?>">
                            <label class="form-check-label fw-semibold" for="course<?php echo e($course->id); ?>"><?php echo e($course->nama); ?></label>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <select class="form-select form-select-sm" name="course_teacher[<?php echo e($course->id); ?>]" disabled>
                    ...
                    <div class="col-md-2">
                        <input type="number" min="1" class="form-control form-control-sm" name="course_sessions[<?php echo e($course->id); ?>]" placeholder="Jml sesi" value="8" disabled>
                    </div>
                    <div class="col-md-4">
                        <div class="input-group input-group-sm">
                            <span class="input-group-text">Rp</span>
                            <input type="number" min="0" class="form-control fee-input" name="course_fee[<?php echo e($course->id); ?>]" value="<?php echo e($fee); ?>" disabled>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="pw-panel" data-step="5">
            ...
            <div class="pw-actions">
                ...
                <button type="submit" class="btn btn-success" id="submitBtn">
                    <span id="submitText"><i class="bi bi-check-circle me-1"></i>Buat Akun Siswa</span>
    ...
    <div id="successPanel" class="pw-card d-none text-center">
        ...
        <div class="d-flex justify-content-center gap-2 mt-4 flex-wrap">
            ...
            <button type="button" class="btn btn-outline-primary" onclick="location.reload()"><i class="bi bi-plus-circle me-1"></i>Registrasi Siswa Lain</button>
...
<script>
const _wizardUrl = "<?php echo e(route('admin.registration.wizard.store')); ?>";
    ...
    btn.addEventListener('click', () => {
        ...
        if (current.dataset.step === '1') {
            ...
            for (const el of required) {
                if (!el.value) { el.reportValidity(); return; }
            }
        }
...
function buildPreview() {
    ...
    document.getElementById('previewBox').innerHTML = `
        <div class="row g-2 mb-3">
            <div class="col-md-6"><span class="text-muted">Nama Siswa:</span> <strong>${name}</strong></div>
...
document.getElementById('wizardForm').addEventListener('submit', function(e) {
    ...
    .then(d => {
        if (d.success) {
            ...
            document.getElementById('wizardForm').classList.add('d-none');
            document.querySelector('.pw-stepper').classList.add('d-none');
            document.getElementById('successPanel').classList.remove('d-none');
        } else {
            showToast(d.message || 'Gagal memproses registrasi.', 'error');
    ...
    .catch((d) => {
        showToast((d && d.message) || 'Terjadi kesalahan. Coba lagi.', 'error');
        submitBtn.disabled = false;
        document.getElementById('submitText').classList.remove('d-none');
        document.getElementById('submitLoading').classList.add('d-none');
    });
...
function sendToWA() {
    ...
    const msg = encodeURIComponent(
        ...
        'Akun Anda telah berhasil dibuat. Berikut data akun login Anda:\n\n' +
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/runner/workspace/resources/views/admin/registration/wizard.blade.php ENDPATH**/ ?>