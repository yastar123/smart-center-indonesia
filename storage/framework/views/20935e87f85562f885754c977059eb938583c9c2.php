...
<div class="dashboard-card mb-4 fade-up" style="background:linear-gradient(135deg,#260632 0%,#461256 50%,#c84ddf 100%);color:white;border:none;overflow:hidden;position:relative">
    ...
    <div class="row align-items-center g-3" style="position:relative">
        ...
        <div class="col-md-4 text-md-end d-flex justify-content-md-end gap-2">
            <a href="<?php echo e(route('admin.subject.create')); ?>" class="btn fw-semibold px-4" style="background:rgba(255,255,255,.2);color:white;border:1px solid rgba(255,255,255,.3);border-radius:10px;backdrop-filter:blur(10px)">
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <div class="d-flex gap-1 justify-content-center">
                            <a href="<?php echo e(route('admin.subject.edit', $s)); ?>" class="btn btn-sm btn-outline-secondary" title="Edit">Edit</a>
                            <form method="POST" action="<?php echo e(route('admin.subject.destroy', $s)); ?>" class="d-inline" onsubmit="return confirm('Hapus mata pelajaran ini?')">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/runner/workspace/resources/views/admin/subject/index.blade.php ENDPATH**/ ?>