...
<div class="dashboard-card mb-4">
    ...
    <div class="mb-4">
        ...
        <select name="mata_pelajaran_id" id="mata_pelajaran_id" class="form-select" required onchange="onCourseChange(this.value)">
            ...
            <option value="<?php echo e($c->id); ?>" data-kategori="<?php echo e($c->kategori ?? ''); ?>" <?php echo e(old('mata_pelajaran_id') == $c->id ? 'selected' : ''); ?>>
                <?php echo e($c->nama); ?><?php echo e($c->kategori ? ' ('.$c->kategori.')' : ''); ?>
