...
<div class="dashboard-card mb-4 fade-up" style="background:linear-gradient(135deg,#260632 0%,#461256 50%,#c84ddf 100%);color:white;border:none;overflow:hidden;position:relative">
    ...
    <div class="row align-items-center g-3" style="position:relative">
        ...
        <div class="col-md-4 text-md-end">
            <button onclick="window.location.href='<?php echo e(route('admin.teachers.create')); ?>'" class="btn fw-semibold px-4"
...
<div class="dashboard-card fade-up">
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-3">
        ...
        <div class="d-flex gap-2">
            ...
            <button class="btn btn-success btn-sm" onclick="window.location.href='<?php echo e(route('admin.teachers.create')); ?>'">
            ...
            if (!teachers.length) {
                html = `<tr><td colspan="12" class="py-5">
                    <div class="text-center">
                        ...
                        <button class="btn btn-sm btn-success" onclick="window.location.href='<?php echo e(route('admin.teachers.create')); ?>'">
                            <i class="bi bi-plus-lg me-1"></i>Tambah Guru
                        </button>
                    </div>
                </td></tr>`;
...
function saveTeacher() {
    ...
    const url = id ? '/admin/teachers/' + id : '<?php echo e(route("admin.teachers.store")); ?>';
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Edu Juanda Pratama\Downloads\smart-center-indonesia-1\smart-center-indonesia-1\resources\views/admin/teachers/index.blade.php ENDPATH**/ ?>