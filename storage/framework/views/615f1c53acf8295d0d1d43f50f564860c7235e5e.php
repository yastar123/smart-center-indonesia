...
unset($__errorArgs, $__bag); ?>"
                       placeholder="MTK-01" value="<?php echo e(old('kode')); ?>" required maxlength="20">
...
unset($__errorArgs, $__bag); ?>"
                       placeholder="cth. Matematika Wajib" value="<?php echo e(old('nama')); ?>" required maxlength="100">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-6">
                ...
                <select name="jenis_kursus" class="form-select <?php $__errorArgs = ['jenis_kursus'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required>
                    ...
                    <?php $__currentLoopData = [
                        ...
                        <option value="<?php echo e($val); ?>" <?php echo e(old('jenis_kursus')==$val?'selected':''); ?>><?php echo e($label); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
                <?php $__errorArgs = ['jenis_kursus'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="invalid-feedback"><?php echo e($message); ?></div><?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                          rows="3" placeholder="Deskripsi singkat mata pelajaran…"><?php echo e(old('deskripsi')); ?></textarea>
