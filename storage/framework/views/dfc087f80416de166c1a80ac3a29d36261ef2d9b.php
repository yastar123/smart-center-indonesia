...
<div class="card-wrap">
    ...
    <div class="card-body-inner">
        ...
        <form method="POST" action="<?php echo e(route('password.store')); ?>" id="resetForm">
            <?php echo csrf_field(); ?>
...
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div style="font-size:.8rem;color:#ef4444;margin-top:4px"><?php echo e($message); ?></div><?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
            </div>
...
<?php /**PATH /home/runner/workspace/resources/views/auth/reset-password.blade.php ENDPATH**/ ?>