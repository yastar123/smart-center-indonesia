<?php $__env->startSection('title', 'Manajemen Promo'); ?>
<?php $__env->startSection('page-title', 'Manajemen Promo'); ?>
...
<div class="dashboard-card mb-4 fade-up"
    ...
    <div class="d-flex align-items-center justify-content-between flex-wrap gap-3" style="position:relative">
        ...
        <a href="<?php echo e(route('owner.promo.create')); ?>"
...
<div class="dashboard-card mb-4 fade-up" style="animation-delay:.03s;padding:16px 20px">
    <form method="GET" class="d-flex align-items-center gap-3 flex-wrap">
        ...
        <select name="status" class="form-select" style="width:160px;border-radius:10px;font-size:13px" onchange="this.form.submit()">
            ...
            <option value="berakhir" <?php echo e(request('status') === 'berakhir' ? 'selected' : ''); ?>>Berakhir</option>
        </select>
        <button type="submit" class="btn btn-primary" style="border-radius:10px;font-size:13px;padding:8px 18px">
            <i class="bi bi-funnel me-1"></i>Filter
        </button>
        <?php if(request('search') || (request('status') && request('status') !== 'semua')): ?>
        <a href="<?php echo e(route('owner.promo.index')); ?>" class="btn" style="border-radius:10px;font-size:13px;border:1px solid var(--card-border);color:var(--text-muted)">Reset</a>
        <?php endif; ?>
    </form>
</div>
...
<div class="dashboard-card fade-up" style="animation-delay:.06s">
    ...
    <div class="text-center py-5">
        ...
        <a href="<?php echo e(route('owner.promo.create')); ?>" class="btn btn-primary" style="border-radius:10px">
            <i class="bi bi-plus-lg me-2"></i>Buat Promo Baru
        </a>
    </div>
    <?php else: ?>
                    ...
                    <td>
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div style="width:52px;height:36px;border-radius:8px;overflow:hidden;flex-shrink:0;background:linear-gradient(135deg,#461256,#c84ddf)">
                                <?php if($p->banner_path): ?>
                                <img src="<?php echo e(asset('storage/'.$p->banner_path)); ?>" alt="" style="width:100%;height:100%;object-fit:cover">
                                <?php else: ?>
                            ...
                            <div>
                                <div class="fw-semibold" style="font-size:13.5px;color:var(--text-primary)"><?php echo e($p->judul); ?></div>
                                <div class="text-muted" style="font-size:11px">ID: <?php echo e($p->kode); ?></div>
                            </div>
                        </div>
                    </td>
                    <td class="d-none d-md-table-cell">
                        <span class="badge mb-1" style="background:<?php echo e($tipeColor); ?>18;color:<?php echo e($tipeColor); ?>;font-size:10.5px;padding:3px 8px;border-radius:6px;display:block;width:fit-content">
                            <?php echo e($p->tipe_label); ?>

                        </span>
                        <div class="text-muted" style="font-size:11px">
                            <?php echo e($p->tanggal_mulai->format('d M')); ?> – <?php echo e($p->tanggal_berakhir->format('d M Y')); ?>
                    ...
                    <td class="d-none d-lg-table-cell">
                        <div class="d-flex justify-content-center gap-4">
                            <div class="text-center">
                                <div class="fw-bold" style="font-size:16px;color:var(--text-primary)"><?php echo e(number_format($p->views)); ?></div>
                                <div class="text-muted" style="font-size:10px">Views</div>
                            </div>
                            <div style="width:1px;background:var(--card-border)"></div>
                            <div class="text-center">
                                <div class="fw-bold" style="font-size:16px;color:#c84ddf"><?php echo e(number_format($p->claims)); ?></div>
                                <div class="text-muted" style="font-size:10px">Claims</div>
                            </div>
                        </div>
                    </td>
                    <td class="text-center">
                        <span class="badge" style="background:<?php echo e($statusColor['bg']); ?>;color:<?php echo e($statusColor['text']); ?>;font-size:11.5px;padding:5px 12px;border-radius:20px;font-weight:600">
                            <?php echo e($p->status_label); ?>

                        </span>
                    </td>
                    <td class="text-center">
                        <a href="<?php echo e(route('owner.promo.show', $p->id)); ?>"
                           class="btn btn-sm"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/runner/workspace/resources/views/owner/promo/index.blade.php ENDPATH**/ ?>