    ...
    <div class="d-flex align-items-center gap-3">
        ...
        <div>
            ...
            <div style="font-size:12.5px;color:var(--text-primary)">
                Anda telah menggunakan <strong><?php echo e($sesiPakaiShow); ?>/<?php echo e($totalSesiShow); ?></strong> sesi.
                Anda tidak dapat mengkonfirmasi kehadiran. Silakan hubungi admin untuk menambah sesi.
            </div>
        </div>
    </div>
</div>
<?php elseif($sisaSesiShow <= 3): ?>
<div class="dashboard-card mb-4 fade-up" style="border-left:4px solid #f6af23;background:var(--soft-warning-bg)">
    <div class="d-flex align-items-center gap-3">
        ...
        <div>
            ...
            <div style="font-size:12.5px;color:var(--text-primary)">
                Sisa <strong><?php echo e($sisaSesiShow); ?></strong> sesi dari total <strong><?php echo e($totalSesiShow); ?></strong> sesi.
