    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .register-card {
            ...
            border: 1px solid rgba(104, 17, 126, 0.12);
            border-radius: 0;
            box-shadow: none;
            padding: 28px;
        }
        ...
        @media (max-width: 980px) {
            ...
            .register-panel { padding-top: 0; }
        }

        @media (max-width: 640px) {
            .register-hero,
            .register-panel { padding: 20px; }
            .register-card { padding: 20px; border-radius: 0; }
        ...
        <section class="register-panel">
            <div class="register-card">
                <div class="register-header">
                    ...
                    <div class="register-badge">Menunggu Verifikasi Admin</div>
                </div>
