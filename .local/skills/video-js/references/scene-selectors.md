...
description: Add interactive scene controls (jump, lock-loop, progress bar) to video-js artifacts. Use when building or updating the scene selector overlay for animated videos. Replaces the old scene-selectors.md pattern with a cleaner hook-based architecture.
---
